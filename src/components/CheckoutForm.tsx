...
export default function CheckoutForm({
  ...
  // Calculate max based on MOQ - allow up to 5x MOQ for bulk orders, minimum 1000
  const maxQuantity = actualMoq ? Math.max(actualMoq * 5, 1000) : 1000;
        ...
        <div className="lg:col-span-2 group overflow-hidden rounded-2xl border-2 border-orange-300/50 bg-gradient-to-br from-white via-orange-50/30 to-amber-50/20 p-6 lg:p-8 shadow-xl hover:shadow-2xl hover:border-orange-400/60 transition-all duration-500 backdrop-blur-sm relative">
          ...
          <div className="relative flex flex-col sm:flex-row items-start gap-6">
            <div className="w-32 h-32 sm:w-36 sm:h-36 shrink-0 overflow-hidden rounded-2xl border-2 border-orange-300 bg-gradient-to-br from-orange-100 to-amber-100 shadow-lg hover:scale-105 transition-all duration-500 hover:shadow-2xl hover:shadow-orange-300/50 relative group/img">
              {img ? (
                ...
                <div className="h-full w-full flex items-center justify-center">
                  <svg className="w-12 sm:w-16 h-12 sm:h-16 text-orange-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div className="min-w-0 flex-1 w-full">
              <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-3 sm:gap-4 mb-4">
                <h2 className="font-extrabold text-xl sm:text-2xl bg-gradient-to-r from-gray-900 via-orange-700 to-amber-600 bg-clip-text text-transparent leading-tight break-words pr-2">
                  {actualTitle}
                </h2>
                {actualPrice && (
                  <div className="shrink-0 px-3 py-1.5 sm:px-4 sm:py-2 rounded-xl bg-gradient-to-r from-orange-500 to-amber-500 shadow-lg self-start">
                    <div className="text-white font-bold text-xs sm:text-sm whitespace-nowrap">Best Price</div>
                  </div>
                )}
              </div>
              ...
              <div className="mt-4 flex flex-wrap items-baseline gap-2">
                <div className="text-2xl sm:text-3xl font-extrabold bg-gradient-to-r from-orange-600 via-amber-600 to-orange-500 bg-clip-text text-transparent">
            ...
            <div className="animate-fade-in-up animation-delay-100">
              <div className="flex items-center justify-between mb-4">
                ...
                <div className="px-3 py-1.5 rounded-lg bg-gradient-to-r from-orange-600 to-amber-600 shadow-lg">
                  <span className="text-white font-bold text-base sm:text-lg">{quantity}</span>
              ...
              <div className="flex items-center gap-3 sm:gap-4">
                <input 
                  ...
                  style={{ // Dynamic gradient based on slider position
                ...
                <input 
                  ...
                  className="w-20 sm:w-24 rounded-xl border-2 border-orange-300 bg-white px-3 sm:px-4 py-2 sm:py-3 text-sm sm:text-base text-center font-bold !text-gray-900 outline-none focus:ring-2 focus:ring-orange-500 focus:border-orange-500 transition-all duration-200 shadow-sm hover:shadow-md"
                />
              </div>
              ...
              {actualMoq && quantity < actualMoq && (
                <div className="mt-4 flex items-start gap-2 text-xs text-orange-800 bg-gradient-to-r from-orange-100 to-amber-100 p-3 sm:p-4 rounded-xl border-2 border-orange-300 shadow-md animate-scale-in">
          ...
          <style jsx>{`
            .slider::-webkit-slider-thumb {
              ...
              box-shadow: 0 3px 8px rgba(249, 115, 22, 0.3), 0 0 0 1px rgba(249, 115, 22, 0.2);
            ...
            .slider::-webkit-slider-thumb:hover {
              box-shadow: 0 6px 16px rgba(249, 115, 22, 0.5), 0 0 0 2px rgba(249, 115, 22, 0.3);
              transform: scale(1.2);
            }
            ...
            .slider::-webkit-slider-thumb:active {
              transform: scale(1.1);
              box-shadow: 0 2px 6px rgba(249, 115, 22, 0.4), 0 0 0 3px rgba(249, 115, 22, 0.2);
            }
