...
export default function ProductDetailClient({ product, pool, similarProducts }: ProductDetailProps) {
  ...
  const { openLightbox, LightboxComponent } = useImageLightbox(images, product.title);
          ...
          >
            {images.length > 0 ? (
              <>
                ...
                {/* Zoom hint */}
                <div className="absolute top-4 left-4 bg-black/70 text-white px-3 py-1.5 rounded-lg text-xs opacity-0 group-hover:opacity-100 transition-opacity">
                  Click to zoom
                </div>
              </>
            ) : (
                ...
                <div className="p-3">
                  ...
                  <div className="h-1.5 bg-gray-200 rounded-full overflow-hidden">
                    <div
                      ...
                      style={{ width: `${item.poolProgress}%` }} // Dynamic progress
                    />
                  </div>
