  ...
  return (
    <div className="relative min-h-screen bg-gradient-to-b from-orange-50/30 via-white to-white">
      ...
      <Section id="customs" title="Customs, Duties & Taxes">
        <div className="space-y-4">
          <div className="flex items-start gap-4 rounded-xl border-2 border-blue-200 bg-gradient-to-r from-blue-50 to-white p-4 shadow-sm">
            <span className="text-2xl">✓</span>
            <div className="text-gray-700">
              We auto-detect routes that qualify for DDP (Delivered Duty Paid) whenever possible - meaning duties and taxes are prepaid.
            </div>
          </div>
          <div className="rounded-2xl border-2 border-orange-200 bg-gradient-to-br from-orange-50 to-white p-6 shadow-lg">
            <div className="font-bold text-lg text-gray-900 mb-3">For DDU (Delivered Duty Unpaid) routes:</div>
            <div className="space-y-3">
              <div className="flex items-start gap-3">
                <span className="text-xl">�</span>
                <div className="text-gray-700">
                  Your local customs may contact you for payment before delivery.
                </div>
              </div>
              <div className="flex items-start gap-3">
                <span className="text-xl">💳</span>
                <div className="text-gray-700">
                  Any unpaid duties or VAT are the buyer's responsibility.
                </div>
              </div>
            </div>
          </div>
          <div className="flex items-start gap-4 rounded-xl border-2 border-emerald-200 bg-gradient-to-r from-emerald-50 to-white p-4 shadow-sm">
            ...
            <div className="text-gray-700">
              <span className="font-semibold text-gray-900">Transparency:</span> We'll always specify the route type (DDP or DDU) during checkout.
            </div>
          </div>
        </div>
      </Section>
      ...
      <Section id="contact" title="Contact & Dispute Resolution">
        <div className="space-y-6">
          <p className="text-lg font-medium text-gray-900">Need help with a shipment or return?</p>
          <p className="text-gray-700">Please include your Order ID when reaching out.</p>
          ...
          <div className="space-y-3">
            ...
            <div className="flex items-center gap-3 rounded-xl border-2 border-blue-200 bg-gradient-to-r from-blue-50 to-white p-4 shadow-sm">
              <span className="text-xl">�</span>
              <div className="text-sm text-gray-700">Report an Issue: via your Order Tracking page</div>
            </div>
            <div className="rounded-xl border-2 border-orange-200 bg-gradient-to-r from-orange-50 to-white p-4 shadow-sm">
              <div className="flex items-start gap-3">
                <span className="text-xl">⚖️</span>
                <div className="text-sm text-gray-700">
                  Payments made via <span className="font-semibold text-gray-900">Stripe or PayPal</span> remain eligible for their Buyer Protection policies in unresolved cases.
                </div>
              </div>
            </div>
          </div>
          <div className="rounded-xl border-2 border-gray-200 bg-gradient-to-r from-gray-50 to-white p-4 shadow-sm">
            <p className="text-xs text-gray-600">
              This policy is a summary and doesn't override our <a href="/terms" className="underline text-orange-600 hover:text-orange-700">Terms of Service</a> or applicable consumer protection laws.
            </p>
          </div>
        </div>
      </Section>
