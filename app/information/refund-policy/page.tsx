      ...
      <div className="mt-6 space-y-4">
        ...
        <Accordion title="Contact">
          ...
          <p className="mt-2 text-sm text-neutral-700">
            Helpful links: <Link className="underline" href="/terms">Terms of Service</Link> · <Link className="underline" href="/privacy">Privacy Policy</Link> · <Link className="underline" href="/information/payment-protection">Payment Protection</Link> · <Link className="underline" href="/support">Contact</Link>
          </p>
        </Accordion>
      </div>
    </section>
