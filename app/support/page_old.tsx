        ...
        <div className="mx-auto w-full max-w-[1000px] px-4 py-10 sm:py-14">
          <div className="flex items-start justify-between gap-3">
            ...
            <div className="hidden sm:flex items-center gap-2">
              <a href={`tel:+6594799717`} className="rounded-full bg-neutral-900 px-3 py-1.5 text-sm font-medium text-white hover:bg-neutral-800">Call us</a>
              <a href={`mailto:${email}`} className="rounded-full border border-neutral-200 px-3 py-1.5 text-sm hover:bg-neutral-50">Email</a>
            </div>
          </div>
        </div>
      </div>
          ...
          <div className="space-y-4">
            ...
            <div className="rounded-xl border border-neutral-200 bg-white p-4">
              ...
              <div className="mt-2 grid gap-2">
                <a href={`/account/messages`} className="rounded-md bg-neutral-900 px-3 py-2 text-sm font-medium text-white hover:bg-neutral-800">Message us on MOQPools</a>
