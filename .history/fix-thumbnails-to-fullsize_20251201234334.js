...
function extractFullSizeUrl(detailJson) {
  ...
  for (const img of gallery) {
    ...
    // Remove thumbnail suffixes FIRST (before dimension checking)
    // Pattern: _NNxNN.ext at the end
    // Handle cases like .jpg_80x80.jpg -> .jpg (not .jpg.jpg)
    ...
    // NOW check for bad dimension patterns in the full-size URL
