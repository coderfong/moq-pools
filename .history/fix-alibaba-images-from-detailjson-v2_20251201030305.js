...
function isValidProductImage(url) {
  ...
  const badPatterns = [
    /tps-\d{2,3}-\d{2,3}[^0-9]/i,     // Small thumbnails (80x80, 50x50, etc - 2-3 digits)
    /tps-\d{3,4}-\d{2,3}[^0-9]/i,     // Banners (920x110, 3840x80, etc - wide x short)
    /tps-\d{2,3}-\d{3,4}[^0-9]/i,     // Vertical banners (80x3840, etc - short x tall)
  ];
