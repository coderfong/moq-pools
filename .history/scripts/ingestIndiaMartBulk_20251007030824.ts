#!/usr/bin/env ts-node
// Force CommonJS for this script to avoid ESM loader issues when invoked via plain `pnpm ts-node`.
// (Other scripts can keep ES imports; this one is frequently run ad-hoc.)
// eslint-disable-next-line @typescript-eslint/no-var-requires
const { flattenIndiaMartLeaves, getIndiaMartSearchTerms } = require('../src/lib/indiamartCategories');
// eslint-disable-next-line @typescript-eslint/no-var-requires
const { fetchIndiaMart } = require('../src/lib/providers/indiamart');
// eslint-disable-next-line @typescript-eslint/no-var-requires
const { upsertSavedListings } = require('../src/lib/listingStore');
// eslint-disable-next-line @typescript-eslint/no-var-requires
const { sanitizeTitle, classify, passesQuality } = require('../src/lib/quality/xrayQuality');
// eslint-disable-next-line @typescript-eslint/no-var-requires
const { termToCategorySlug } = require('../src/lib/quality/termCategory');
