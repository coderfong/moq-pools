...
import { INDIAMART_CATEGORIES, IndiaMartCategoryNode, flattenIndiaMartLeaves, getIndiaMartSearchTerms } from '@/lib/indiamartCategories';
...
function findTopGroup(label: string): IndiaMartCategoryNode | undefined {
