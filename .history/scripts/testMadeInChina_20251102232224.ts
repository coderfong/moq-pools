...
async function testMadeInChina() {
  const url = 'https://gleelight.en.made-in-china.com/product/sNOmyjbgPCcU/China-1000W-Outdoor-Exterior-Super-Brightness-LED-Moving-Motorized-Fx-Strobe-Wash-Stage-Light.html';
