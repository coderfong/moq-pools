...
export const CATEGORIES: CategoryDef[] = [
  ...
  { key: 'vehicle-parts', featured: [
    'Brake Pads','Shock Absorber','Fuel Injector','Alternator','Radiator','Clutch Kit','Turbocharger','Ignition Coil','Control Arm','Catalytic Converter','Piston Rings','Oil Filter','Timing Belt'
  ]},
  { key: 'tools-hardware', featured: [
    'Cordless Drill','Angle Grinder','Impact Wrench','Screwdriver Set','Socket Set','Heat Gun','Measuring Tape','Hammer Drill','Circular Saw','Welding Machine','Tool Chest','Bench Vise','Air Compressor'
  ]},
  { key: 'renewable-energy', featured: [
    'Solar Panel','Solar Inverter','Solar Battery','Solar Charge Controller','Solar Street Light','Wind Turbine','Solar Mounting Brackets','Solar Cable','Hybrid Inverter','MPPT Controller','Solar Pump Inverter','LiFePO4 Battery','Off Grid Inverter'
  ]},
