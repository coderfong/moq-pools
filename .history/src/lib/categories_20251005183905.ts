...
export const CATEGORIES: Category[] = [
  ...
  { key: 'building-materials-equipment', label: 'Building Materials & Equipment', shortLabel: 'Building Mater.', term: 'Building Construction Material Equipment', featured: [
  ...
  { key: 'pharma-drugs', label: 'Pharma Drugs & Supplements', shortLabel: 'Pharma', term: 'Pharmaceutical Drug', featured: [
  ...
  { key: 'hospital-medical-equipment', label: 'Hospital & Medical Equipment', shortLabel: 'Hospital Equip', term: 'Medical Equipment', featured: [
  ...
  { key: 'industrial-plants-machinery', label: 'Industrial Plants & Machinery', shortLabel: 'Plants & Mach.', term: 'Industrial Plants Machinery', featured: [
  ...
  { key: 'packaging-material-machines', label: 'Packaging Material & Machines', shortLabel: 'Packaging Ext', term: 'Packaging Material Machines', featured: [
  ...
  { key: 'chemicals-dyes', label: 'Chemicals, Dyes & Solvents', shortLabel: 'Chemicals', term: 'Chemicals Dyes Solvents', featured: [
  ...
  { key: 'transportation-logistics', label: 'Transportation & Logistics', shortLabel: 'Logistics', term: 'Transportation Logistics Services', featured: [
