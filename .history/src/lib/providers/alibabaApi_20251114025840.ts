    ...
    try {
      ...
      try {
        if (contentType.includes('application/json')) {
          ...
          // Many OAuth servers return x-www-form-urlencoded, not JSON
          // e.g., "access_token=xxx&refresh_token=yyy&expires_in=123..."
        ...
        console.error('[AlibabaAPI] Failed to parse token response:', parseError);
