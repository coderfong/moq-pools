 ...
 * 
 * OAuth Flow (Alibaba.com ICBU):
 * - Authorize URL: https://openapi-auth.alibaba.com/oauth/authorize
 * - Token Exchange: https://oauth.alibaba.com/token (standard OAuth2 endpoint)
 * - Business APIs: https://openapi.alibaba.com/openapi/... (requires access token)
 * 
 * CRITICAL: The redirect_uri must match EXACTLY in both authorize and token calls
 * 
 * Note: Alibaba uses standard OAuth2 endpoints for seller authorization flow.
 */
...
const ALIBABA_OAUTH_TOKEN_URL = 'https://oauth.alibaba.com/token';
