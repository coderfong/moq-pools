 ...
 * - Parameters: app_key, code, timestamp, sign_method (sha256), sign
 * - Signature: HMAC-SHA256(API_PATH + sorted_params, app_secret)
...
// Alibaba IOP (International Open Platform) endpoints
const ALIBABA_AUTH_BASE = 'https://openapi-auth.alibaba.com';
const ALIBABA_REST_GATEWAY = 'https://openapi.alibaba.com';
