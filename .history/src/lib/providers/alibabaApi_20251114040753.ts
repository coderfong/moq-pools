...
export class AlibabaApiClient {
   ...
   * - Authorize URL: https://openapi-auth.alibaba.com/oauth/authorize
   * - Token URL: https://openapi.alibaba.com/openapi/param2/1/system.oauth2/getToken/{APP_KEY}
   */
  async exchangeCodeForToken(authorizationCode: string): Promise<TokenResponse | null> {
    ...
    try {
      ...
      // IMPORTANT: Use the Open Platform gateway (openapi.alibaba.com), not gw.api.alibaba.com
      // The gateway host must match where your app was created
      // Pattern: /openapi/param2/1/system.oauth2/getToken/{APP_KEY}
      ...
      console.log('[AlibabaAPI] Seller ID:', data.seller_id || data.resource_owner || 'N/A');
