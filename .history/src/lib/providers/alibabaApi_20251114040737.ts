 ...
 * - Token Exchange: https://gw.api.alibaba.com/openapi/param2/1/system.oauth2/getToken/{APP_KEY}
 ...
 * the API gateway for token exchange. This is their documented pattern.
 */
