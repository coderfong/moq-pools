...
export const ICONS: Record<string, LucideIcon> = {
  // New top-level taxonomy keys
  'home-living': Home,
  'fashion-apparel': Shirt,
  'jewelry-accessories': Gem,
  'beauty-personal-care': Sparkles,
  'toys-games-hobbies': Puzzle,
  'stationery-office': NotebookText,
  'bags-travel': Briefcase,
  'fitness-sports': Dumbbell,
  'tech-electronics': Monitor,
  'eco-sustainable-living': Leaf,
  'baby-kids': Gift,
  'garden-outdoor': Leaf,
  'party-gifts-seasonal': Gift,
  'business-packaging-supplies': Package,
  'trend-niche-products': Sparkles,
