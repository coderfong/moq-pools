...
export default function Hero() {
  ...
  return (
    <section className="relative overflow-hidden w-full bg-gradient-to-br from-orange-50 via-white to-amber-50">
      ...
      <div className="relative container mx-auto px-6 md:px-10 xl:px-16 py-12 md:py-16 lg:py-20">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          <div className="order-first lg:order-none flex items-center justify-center">
            <div className="relative">
              ...
              <HeroCarousel items={slides} className="relative mx-auto w-full max-w-[560px] h-[420px] md:h-[480px] lg:h-[520px]" />
            </div>
          </div>
        </div>
      </div>
