  ...
  return (
    <>
      <header className={`sticky top-0 z-50 transition-all duration-500 ${scrolled ? 'bg-white/95 backdrop-blur-2xl shadow-xl border-b border-orange-100' : 'bg-white/80 backdrop-blur-xl shadow-md'}`}>
        ...
        <div className={`w-full max-w-full px-2 sm:px-4 md:px-8 xl:px-20 h-14 sm:h-16 md:h-20 flex items-center ${isAdmin ? 'justify-between' : 'justify-between'}`}>
          {/* Enhanced Brand */}
          <Link href="/" className={`flex items-center gap-3 group ${!isAdmin ? 'md:absolute md:left-8 md:xl:left-20' : ''}`}>
            <div className="relative">
              <span className="w-8 h-8 sm:w-10 sm:h-10 md:w-12 md:h-12 rounded-lg sm:rounded-xl bg-gradient-to-br from-orange-500 via-orange-600 to-amber-500 flex items-center justify-center shadow-lg group-hover:shadow-2xl transition-all duration-300 group-hover:scale-105">
            ...
            <span className="text-lg sm:text-xl md:text-2xl lg:text-3xl font-bold bg-gradient-to-r from-orange-600 via-orange-500 to-amber-500 bg-clip-text text-transparent group-hover:from-orange-700 group-hover:to-amber-600 transition-all">
              PoolBuy
            </span>
          </Link>
