      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="relative">
          ...
          <div className="hidden lg:flex items-start justify-between max-w-6xl mx-auto">
            {steps.map((step, i) => (
              <div key={i} className="flex flex-col items-center relative" style={{ width: '18%' }}>
                {/* Step Card */}
                <div className="group relative w-full">
                  ...
                  <div className="relative bg-white rounded-2xl p-6 shadow-lg hover:shadow-2xl transition-all duration-300 border border-gray-100 hover:-translate-y-2 min-h-[200px] flex flex-col">
                    <div className={`inline-flex items-center justify-center w-14 h-14 rounded-2xl bg-gradient-to-br ${step.bgColor} ${step.textColor} mb-4 group-hover:scale-110 transition-transform`}>
                      {step.icon}
                    </div>
