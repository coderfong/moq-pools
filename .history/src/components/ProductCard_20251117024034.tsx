      ...
      <Link href={href} className="block">
        ...
        <div className="p-3">
          ...
          <div className="mt-3 flex items-center gap-2">
            <a href="http://localhost:3007/products" className="inline-flex items-center justify-center rounded-full font-medium btn-mag btn-primary-gradient shadow-card hover:shadow-lg text-xs px-3 py-1.5">Join Pool</a>
