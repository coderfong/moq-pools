      ...
      {isOpen && (
        <div className="absolute right-0 mt-2 w-80 rounded-2xl border-2 border-orange-200/50 bg-white shadow-2xl z-50">
          ...
          <div className="max-h-96 overflow-y-auto">
            {/* Mock notifications */}
            <div className="p-4 hover:bg-orange-50 cursor-pointer border-b border-gray-100">
              <div className="flex items-start gap-3">
                <div className="w-2 h-2 rounded-full bg-orange-600 mt-2" />
                <div className="flex-1">
                  <p className="text-sm font-medium text-gray-900">Pool closing soon!</p>
                  <p className="text-xs text-gray-600 mt-1">The Mechanical Keyboard pool closes in 2 hours</p>
            ...
            <div className="p-4 hover:bg-orange-50 cursor-pointer border-b border-gray-100">
              <div className="flex items-start gap-3">
                <div className="w-2 h-2 rounded-full bg-orange-600 mt-2" />
                <div className="flex-1">
                  <p className="text-sm font-medium text-gray-900">Pool reached MOQ!</p>
                  <p className="text-xs text-gray-600 mt-1">LED Strip Lights pool has reached minimum order quantity</p>
            ...
            <div className="p-4 hover:bg-orange-50 cursor-pointer border-b border-gray-100">
              <div className="flex items-start gap-3">
                <div className="w-2 h-2 rounded-full bg-orange-600 mt-2" />
                <div className="flex-1">
                  <p className="text-sm font-medium text-gray-900">New pool available</p>
                  <p className="text-xs text-gray-600 mt-1">Check out the new Smart Watch pool</p>
