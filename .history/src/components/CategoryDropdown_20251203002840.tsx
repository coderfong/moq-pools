  ...
  return (
    <div ref={rootRef} className="relative inline-block text-left">
      ...
      >
        ...
        <div className="title-box inline-flex items-center gap-1 sm:gap-2 px-1.5 sm:px-3 py-1 sm:py-2 rounded-md sm:rounded-lg border border-gray-200 bg-white shadow-sm hover:bg-gray-50">
          <i className="iconfont ic_homecate_nor ico inline-flex items-center justify-center w-3.5 h-3.5 sm:w-5 sm:h-5 rounded-sm sm:rounded-md bg-orange-50 text-orange-600 ring-1 ring-orange-100">
            {/* grid icon */}
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" className="w-2 h-2 sm:w-3 sm:h-3"><rect x="3" y="3" width="7" height="7"/><rect x="14" y="3" width="7" height="7"/><rect x="3" y="14" width="7" height="7"/><rect x="14" y="14" width="7" height="7"/></svg>
          </i>
          <span className="tit text-[10px] sm:text-sm font-semibold text-gray-900">Categories</span>
        </div>
      </button>
      ...
      {open && (
        <>
          ...
          <div className="md:hidden fixed inset-x-0 bottom-0 z-50 bg-white rounded-t-2xl shadow-2xl max-h-[70vh] flex flex-col" onClick={(e) => e.stopPropagation()}>
            <div className="flex-shrink-0 flex items-center justify-between px-3 py-2 border-b border-gray-200 bg-white rounded-t-2xl">
              <div className="flex items-center gap-1.5">
                <i className="inline-flex items-center justify-center w-4 h-4 rounded-md bg-orange-50 text-orange-600 ring-1 ring-orange-100">
                  <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" className="w-2.5 h-2.5"><rect x="3" y="3" width="7" height="7"/><rect x="14" y="3" width="7" height="7"/><rect x="3" y="14" width="7" height="7"/><rect x="14" y="14" width="7" height="7"/></svg>
                </i>
                <span className="text-sm font-bold text-gray-900">Categories</span>
              </div>
              <button onClick={() => setOpen(false)} className="p-1.5 text-gray-600 hover:text-gray-900 -mr-1">
