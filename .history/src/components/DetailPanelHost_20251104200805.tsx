          ...
          <div className="p-4 space-y-3">
            ...
            <div className="relative">
              <div className="h-2.5 rounded-full bg-orange-100 overflow-hidden">
                <div 
                  className="h-full bg-gradient-to-r from-orange-400 to-orange-500 transition-all duration-500 shadow-sm progress-bar"
            ...
            <style jsx>{`
              .progress-bar[data-progress="${poolProgress}"] {
                width: ${poolProgress}%;
              }
            `}</style>
