...
export default function CTA() {
  return (
    <section className="py-28 md:py-32 lg:py-36 relative overflow-hidden bg-gradient-to-b from-orange-50 to-amber-50">
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="max-w-5xl mx-auto text-center space-y-10">
          ...
          <div className="flex flex-col sm:flex-row gap-5 justify-center pt-6">
            <Link href="/register" className="inline-flex items-center justify-center gap-2 whitespace-nowrap font-medium ring-offset-background focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 bg-primary text-primary-foreground hover:scale-105 shadow-lg hover:shadow-xl transition-all rounded-md text-xl px-10 py-7 h-auto">
              Get Started Free
