    ...
    <>
      <header className={`sticky top-0 z-50 transition-all duration-500 ${scrolled ? 'bg-white/95 backdrop-blur-2xl shadow-xl border-b border-orange-100' : 'bg-white/80 backdrop-blur-xl shadow-md'}`}>
        ...
        <div className={`w-screen max-w-none px-6 md:px-10 xl:px-16 h-16 md:h-[72px] flex items-center ${isAdmin ? 'justify-between' : 'justify-center md:justify-between'}`}>
          ...
          <nav className={`hidden md:flex items-center gap-2 lg:gap-4 text-sm font-semibold ${!isAdmin ? 'mx-auto' : ''}`}>
            <Link href="/products" className="relative px-3 py-2 text-gray-700 hover:text-orange-600 transition-colors group">
              Browse
            ...
            <Link href="/#how-it-works" className="relative px-3 py-2 text-gray-700 hover:text-orange-600 transition-colors whitespace-nowrap group">
              How It Works
              <span className="absolute bottom-0 left-0 w-full h-0.5 bg-gradient-to-r from-orange-500 to-amber-500 scale-x-0 group-hover:scale-x-100 transition-transform origin-left"></span>
            </Link>
            <Link href="/#benefits" className="relative px-3 py-2 text-gray-700 hover:text-orange-600 transition-colors group">
              Benefits
              <span className="absolute bottom-0 left-0 w-full h-0.5 bg-gradient-to-r from-orange-500 to-amber-500 scale-x-0 group-hover:scale-x-100 transition-transform origin-left"></span>
            </Link>
            <Link href="/about" className="relative px-3 py-2 text-gray-700 hover:text-orange-600 transition-colors group">
              About
              <span className="absolute bottom-0 left-0 w-full h-0.5 bg-gradient-to-r from-orange-500 to-amber-500 scale-x-0 group-hover:scale-x-100 transition-transform origin-left"></span>
            </Link>
            <Link href="/support" className="relative px-3 py-2 text-gray-700 hover:text-orange-600 transition-colors group">
              Support
              <span className="absolute bottom-0 left-0 w-full h-0.5 bg-gradient-to-r from-orange-500 to-amber-500 scale-x-0 group-hover:scale-x-100 transition-transform origin-left"></span>
            </Link>
          </nav>
