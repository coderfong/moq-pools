        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-center">
          ...
          <div className="flex flex-col justify-center animate-fade-in-up">
            <div className="space-y-5 md:space-y-6">
              ...
              <h1 className="font-display text-4xl font-bold leading-[1.1] text-gray-900 tracking-tight">
                Buy Together.{' '}
              ...
              <p className="text-base text-gray-600 max-w-xl leading-relaxed font-medium">
          ...
          <div className="order-first lg:order-none flex items-center justify-center lg:justify-end animate-fade-in-up animation-delay-300">
            <div className="relative w-full max-w-[500px] px-0">
              ...
              <HeroCarousel items={slides} className="relative w-full h-[450px] shadow-2xl rounded-2xl" />
            </div>
          </div>
        </div>
      </div>
