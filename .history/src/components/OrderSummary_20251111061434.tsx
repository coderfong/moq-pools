...
export default function OrderSummary({ 
  ...
  return (
    <div className="overflow-hidden rounded-2xl border-2 border-orange-300/50 bg-gradient-to-br from-white via-orange-50/30 to-amber-50/20 p-6 shadow-xl hover:shadow-2xl transition-all duration-500 backdrop-blur-sm">
      <div className="font-extrabold text-xl bg-gradient-to-r from-gray-900 via-orange-700 to-amber-600 bg-clip-text text-transparent mb-6">
        Order Summary
      </div>
