...
import SharedCategoryMenu from '@/components/SharedCategoryMenu';
          ...
          <IndiaMartCategoryMenu
            onSelect={(leaf) => {
              ...
              const usp = new URLSearchParams({
                ...
                page: '1',
                lk: leaf.key,
                // lightweight prefetch flag encourages faster server path if supported
                prefetch: '1'
              });
              setPending(true);
