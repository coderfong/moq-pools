...
export default function Hero() {
  ...
  return (
    <section className="relative overflow-hidden w-full bg-gradient-to-br from-orange-50 via-white to-amber-50">
      ...
      <div className="relative container mx-auto px-4 md:px-6 lg:px-8 xl:px-16 py-16 md:py-20 lg:py-24 xl:py-28">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          <div className="flex flex-col justify-center animate-fade-in-up">
            <div className="space-y-6 md:space-y-8">
              ...
              <h1 className="font-display text-4xl sm:text-5xl lg:text-6xl xl:text-7xl font-bold leading-[1.1] text-gray-900 tracking-tight">
                Pool Orders,{' '}
                <span className="relative inline-block mt-2">
                  ...
                  <svg className="absolute -right-8 -top-4 w-12 h-12 text-orange-400 opacity-20 animate-bounce-slow" fill="currentColor" viewBox="0 0 20 20">
