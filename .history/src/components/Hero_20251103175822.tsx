        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          <div className="flex flex-col justify-center">
            <div className="space-y-6 md:space-y-8">
              ...
              {/* Heading */}
              <h1 className="font-display text-5xl lg:text-6xl xl:text-7xl font-bold leading-[1.1] text-gray-900">
                Pool Orders,{' '}
              ...
              <div className="flex flex-wrap items-center gap-6 md:gap-8 pt-4">
                <div className="bg-white/80 backdrop-blur-sm px-4 py-3 rounded-xl border border-gray-100 shadow-md">
                  <div className="text-2xl md:text-3xl font-bold bg-gradient-to-r from-orange-600 to-amber-600 bg-clip-text text-transparent">
                    $2.5M+
                  </div>
                  <div className="text-sm text-gray-600 font-medium">Saved Together</div>
                </div>
                <div className="bg-white/80 backdrop-blur-sm px-4 py-3 rounded-xl border border-gray-100 shadow-md">
                  <div className="text-2xl md:text-3xl font-bold bg-gradient-to-r from-orange-600 to-amber-600 bg-clip-text text-transparent">
                    500+
                  </div>
                  <div className="text-sm text-gray-600 font-medium">Active Pools</div>
                </div>
                <div className="bg-white/80 backdrop-blur-sm px-4 py-3 rounded-xl border border-gray-100 shadow-md">
                  <div className="text-2xl md:text-3xl font-bold bg-gradient-to-r from-orange-600 to-amber-600 bg-clip-text text-transparent">
                    98%
          ...
          <div className="order-first lg:order-none flex items-center justify-center lg:justify-end">
            <div className="relative w-full max-w-[500px] px-4 lg:px-0">
              ...
              <HeroCarousel items={slides} className="relative w-full h-[400px] md:h-[450px] lg:h-[500px]" />
            </div>
          </div>
        </div>
      </div>
