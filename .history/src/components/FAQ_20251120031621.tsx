    ...
    <section className="py-20 bg-gradient-to-b from-white to-gray-50" id="faq">
      <div className="max-w-4xl mx-auto px-6 md:px-10">
        ...
        <div className="text-center mb-12">
          <div className="inline-flex items-center justify-center w-16 h-16 rounded-2xl bg-gradient-to-br from-orange-500 to-orange-600 mb-6 shadow-lg shadow-orange-500/30">
