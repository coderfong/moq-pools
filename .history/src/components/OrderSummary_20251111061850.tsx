  ...
  return (
    <div className="group overflow-hidden rounded-2xl border-2 border-orange-300/50 bg-gradient-to-br from-white via-orange-50/30 to-amber-50/20 p-6 shadow-xl hover:shadow-2xl hover:border-orange-400/60 transition-all duration-500 backdrop-blur-sm sticky top-6">
      ...
      <div className="space-y-4 text-sm">
        <div className="group/item flex items-center justify-between p-3 rounded-xl bg-white/50 hover:bg-white/80 transition-all duration-200 border border-orange-100 hover:border-orange-200 hover:shadow-md">
          <span className="flex items-center gap-2 text-neutral-700 font-medium">
            <svg className="w-5 h-5 text-orange-600 group-hover/item:scale-110 transition-transform duration-200" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div className="group/item flex items-center justify-between p-3 rounded-xl bg-gradient-to-r from-green-50 to-emerald-50 border border-green-200 hover:shadow-md transition-all duration-200">
          <span className="flex items-center gap-2 text-green-800 font-medium">
            <svg className="w-5 h-5 text-green-600 group-hover/item:scale-110 group-hover/item:rotate-12 transition-all duration-200" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div className="pt-4 border-t-2 border-orange-200/50">
          <div className="flex items-center justify-between p-4 rounded-xl bg-gradient-to-r from-orange-100 to-amber-100 border-2 border-orange-300 shadow-lg">
            <span className="flex items-center gap-2 text-neutral-900 font-bold text-base">
              <svg className="w-6 h-6 text-orange-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
              </svg>
              Total
            </span>
            <span className="text-2xl font-extrabold bg-gradient-to-r from-orange-600 via-amber-600 to-orange-500 bg-clip-text text-transparent">
              {formatCurrencyStable(subtotal ?? null, currency)}
            </span>
          </div>
        </div>
      ...
      <div className="mt-6 flex items-start gap-3 text-xs text-neutral-700 bg-gradient-to-r from-orange-50/80 to-amber-50/80 p-4 rounded-xl border-2 border-orange-200 shadow-sm hover:shadow-md transition-all duration-200">
        <input 
          id="consent" 
          type="checkbox" 
          className="mt-0.5 h-5 w-5 rounded-md border-2 border-orange-400 text-orange-600 focus:ring-orange-500 focus:ring-2 cursor-pointer transition-all duration-200 hover:scale-110" 
          checked={agreed} 
          onChange={(e) => setAgreed(e.target.checked)} 
        />
        <label htmlFor="consent" className="select-none cursor-pointer leading-relaxed">
      ...
      <button 
        ...
        className={`mt-6 w-full rounded-xl bg-gradient-to-r from-orange-500 via-orange-600 to-amber-600 px-6 py-4 text-lg font-extrabold text-white shadow-xl hover:shadow-2xl hover:shadow-orange-500/50 transition-all duration-300 relative overflow-hidden group/btn ${disabled ? 'opacity-60 cursor-not-allowed hover:scale-100 hover:shadow-xl' : 'cursor-pointer hover:scale-105 animate-pulse-subtle'}`}
      >
        {/* Button shine effect */}
