export default function TrustStrip() {
  const items = [
    { name: 'Alibaba', logo: '/logos/alibaba.svg' },
    { name: 'AliExpress', logo: '/logos/aliexpress.svg' },
    { name: '1688', logo: '/logos/1688.svg' },
    { name: 'Taobao', logo: '/logos/taobao.svg' },
    { name: 'Made‑in‑China', logo: '/logos/madeinchina.svg' },
  ];
  return (
