...
type BtnProps = React.ComponentProps<'button'> & Common & { as?: 'button' };
type AnchorProps = React.ComponentProps<'a'> & Common & { as: 'a' };

export default function Button(allProps: BtnProps | AnchorProps) {
  const {
    children,
    variant = 'primary',
    size = 'md',
