...
export default function PageDropdown() {
  ...
  React.useEffect(() => {
    ...
    // Note: Admin check removed - now handled by parent Navbar's NavbarAuthProvider
    // PageDropdown should not be rendered if user is not admin
    setIsAdmin(true); // Assume admin if this component is rendered
