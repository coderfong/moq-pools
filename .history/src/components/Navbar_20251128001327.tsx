  ...
  return (
    <>
      <header className={`sticky top-0 z-50 transition-all duration-500 ${scrolled ? 'bg-white/95 backdrop-blur-2xl shadow-xl border-b border-orange-100' : 'bg-white/80 backdrop-blur-xl shadow-md'}`}>
        ...
        <div className={`w-full max-w-full px-6 md:px-10 xl:px-16 h-16 md:h-[72px] flex items-center ${isAdmin ? 'justify-between' : 'justify-center md:justify-between'}`}>
          {/* Enhanced Brand */}
          <Link href="/" className={`flex items-center gap-2.5 group ${!isAdmin ? 'md:absolute md:left-6 md:xl:left-16' : ''}`}>
            <div className="relative">
              <span className="w-11 h-11 rounded-xl bg-gradient-to-br from-orange-500 via-orange-600 to-amber-500 flex items-center justify-center shadow-lg group-hover:shadow-xl transition-all duration-300 group-hover:scale-110">
                <ShoppingBag className="w-6 h-6 text-white" />
              </span>
              {/* Pulse ring on hover */}
              <span className="absolute inset-0 rounded-xl bg-orange-500 opacity-0 group-hover:opacity-20 group-hover:scale-125 transition-all duration-500"></span>
            </div>
            <span className="text-2xl font-bold bg-gradient-to-r from-orange-600 via-orange-500 to-amber-500 bg-clip-text text-transparent group-hover:from-orange-700 group-hover:to-amber-600 transition-all">
              PoolBuy
            </span>
          </Link>

          {/* Enhanced Primary nav with hover underline effect */}
          <nav className={`hidden md:flex items-center gap-3 lg:gap-5 text-base font-semibold ${!isAdmin ? 'mx-auto' : ''}`}>
            <Link href="/products" className="relative px-4 py-2 text-gray-700 hover:text-orange-600 transition-colors group">
              Browse
            ...
            <Link href="/#how-it-works" className="relative px-4 py-2 text-gray-700 hover:text-orange-600 transition-colors whitespace-nowrap group">
              How It Works
              <span className="absolute bottom-0 left-0 w-full h-0.5 bg-gradient-to-r from-orange-500 to-amber-500 scale-x-0 group-hover:scale-x-100 transition-transform origin-left"></span>
            </Link>
            <Link href="/#benefits" className="relative px-4 py-2 text-gray-700 hover:text-orange-600 transition-colors group">
              Benefits
              <span className="absolute bottom-0 left-0 w-full h-0.5 bg-gradient-to-r from-orange-500 to-amber-500 scale-x-0 group-hover:scale-x-100 transition-transform origin-left"></span>
            </Link>
            <Link href="/about" className="relative px-4 py-2 text-gray-700 hover:text-orange-600 transition-colors group">
              About
              <span className="absolute bottom-0 left-0 w-full h-0.5 bg-gradient-to-r from-orange-500 to-amber-500 scale-x-0 group-hover:scale-x-100 transition-transform origin-left"></span>
            </Link>
            <Link href="/support" className="relative px-4 py-2 text-gray-700 hover:text-orange-600 transition-colors group">
              Support
              <span className="absolute bottom-0 left-0 w-full h-0.5 bg-gradient-to-r from-orange-500 to-amber-500 scale-x-0 group-hover:scale-x-100 transition-transform origin-left"></span>
            </Link>
          </nav>
          ...
          <div className={`hidden md:flex items-center gap-1.5 lg:gap-2.5 ${!isAdmin ? 'md:absolute md:right-6 md:xl:right-16' : ''}`}>
            {/* Shopping Cart */}
            <ShoppingCartLink />
            {/* Wishlist link */}
            <WishlistLink />
