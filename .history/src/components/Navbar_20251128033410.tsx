  ...
  return (
    <>
      <header className={`sticky top-0 z-50 transition-all duration-500 ${scrolled ? 'bg-white/95 backdrop-blur-2xl shadow-xl border-b border-orange-100' : 'bg-white/80 backdrop-blur-xl shadow-md'}`}>
        ...
        <div className={`w-full max-w-full px-4 md:px-8 xl:px-20 h-16 md:h-20 flex items-center ${isAdmin ? 'justify-between' : 'justify-center md:justify-between'}`}>
          {/* Enhanced Brand */}
          <Link href="/" className={`flex items-center gap-3 group ${!isAdmin ? 'md:absolute md:left-8 md:xl:left-20' : ''}`}>
            ...
            <span className="text-2xl md:text-3xl font-bold bg-gradient-to-r from-orange-600 via-orange-500 to-amber-500 bg-clip-text text-transparent group-hover:from-orange-700 group-hover:to-amber-600 transition-all">
              PoolBuy
            </span>
          </Link>
