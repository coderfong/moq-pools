    ...
    <motion.div variants={hoverCard} initial="rest" whileHover="hover" animate="rest" className="rounded-2xl bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 shadow-card">
      <Link href={href} className="block">
        ...
        <div className="p-3">
          ...
          <div className="font-medium text-sm mt-0.5 text-gray-900 dark:text-gray-100 line-clamp-2 md:line-clamp-none" title={title}>{title}</div>
          ...
          <div className="mt-3 flex items-center gap-2">
            <a href={href} className="inline-flex items-center justify-center rounded-full font-medium btn-mag btn-primary-gradient shadow-card hover:shadow-lg text-xs px-3 py-1.5">Join Pool</a>
            <a href={href} className="text-xs px-3 py-1.5 rounded-full border border-gray-200 hover:bg-gray-50">Details</a>
          </div>
        </div>
      </Link>
    </motion.div>
