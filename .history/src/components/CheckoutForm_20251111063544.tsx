            ...
            <div className="animate-fade-in-up animation-delay-100">
              ...
              <div className="flex items-center gap-3 sm:gap-4">
                ...
                <input 
                  ...
                  className="w-20 sm:w-24 rounded-xl border-2 border-orange-300 bg-white px-3 sm:px-4 py-2 sm:py-3 text-sm sm:text-base text-center font-bold text-neutral-900 outline-none focus:ring-2 focus:ring-orange-500 focus:border-orange-500 transition-all duration-200 shadow-sm hover:shadow-md"
                />
              </div>
