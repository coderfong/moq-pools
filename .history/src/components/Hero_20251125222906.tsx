          ...
          <div className="flex flex-col justify-center animate-fade-in-up">
            <div className="space-y-5 md:space-y-6">
              ...
              <div className="flex flex-col sm:flex-row gap-4 pt-4">
                ...
                <Link 
                  href="#how-it-works" 
                  className="group inline-flex items-center justify-center gap-2 bg-white/90 backdrop-blur-sm text-gray-900 px-8 py-4 rounded-xl font-semibold text-base border-2 border-gray-200 hover:border-orange-500 hover:bg-orange-50 transition-all duration-300 shadow-lg hover:shadow-xl hover:scale-105"
                >
