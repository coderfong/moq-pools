...
export default function Hero() {
  ...
  return (
    <section className="relative overflow-hidden w-full bg-gradient-to-br from-orange-50 via-white to-amber-50">
      ...
      <div className="relative container mx-auto px-3 sm:px-4 md:px-6 lg:px-8 xl:px-16 py-8 sm:py-10 md:py-14 lg:py-16">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-center">
          ...
          <div className="flex flex-col justify-center animate-fade-in-up">
            <div className="space-y-5 md:space-y-6">
              ...
              <h1 className="font-display text-2xl sm:text-3xl md:text-4xl lg:text-5xl xl:text-6xl font-bold leading-[1.1] text-gray-900 tracking-tight">
                Buy Together.{' '}
              ...
              <p className="text-sm sm:text-base md:text-lg text-gray-600 max-w-xl leading-relaxed font-medium">
              ...
              <div className="flex flex-col sm:flex-row gap-3 pt-3">
                <Link 
                  href="#pools" 
                  className="group relative inline-flex items-center justify-center gap-1.5 sm:gap-2 bg-gradient-to-r from-orange-500 via-orange-600 to-orange-500 bg-size-200 bg-pos-0 hover:bg-pos-100 text-white px-4 sm:px-6 md:px-7 py-2.5 sm:py-3 md:py-3.5 rounded-lg sm:rounded-xl font-semibold text-sm sm:text-base shadow-xl hover:shadow-2xl hover:shadow-orange-500/50 transition-all duration-300 hover:scale-105 overflow-hidden"
                >
                ...
                <Link 
                  href="#how-it-works" 
                  className="group inline-flex items-center justify-center gap-1.5 sm:gap-2 bg-white/90 backdrop-blur-sm text-gray-900 px-4 sm:px-6 md:px-7 py-2.5 sm:py-3 md:py-3.5 rounded-lg sm:rounded-xl font-semibold text-sm sm:text-base border-2 border-gray-200 hover:border-orange-500 hover:bg-orange-50 transition-all duration-300 shadow-lg hover:shadow-xl hover:scale-105"
                >
          ...
          <div className="order-first lg:order-none flex items-center justify-center lg:justify-end animate-fade-in-up animation-delay-300">
            <div className="relative w-full max-w-[500px] px-2 sm:px-4 lg:px-0">
              ...
              <HeroCarousel items={slides} className="relative w-full h-[200px] sm:h-[280px] md:h-[350px] lg:h-[450px] shadow-2xl rounded-xl sm:rounded-2xl" />
            </div>
          </div>
        </div>
      </div>
