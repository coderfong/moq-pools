        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
          ...
          <div>
            ...
            <ul className="space-y-1 text-sm text-muted">
              ...
              <li><Link href="/support" className="link-underline">Contact</Link></li>
            </ul>
          </div>
          <div>
            <div className="font-semibold mb-2">Legal</div>
            <ul className="space-y-1 text-sm text-muted">
              <li><Link href="/terms" className="link-underline">Terms of Service</Link></li>
              <li><Link href="/privacy" className="link-underline">Privacy Policy</Link></li>
              <li><Link href="/refund-policy" className="link-underline">Refund Policy</Link></li>
