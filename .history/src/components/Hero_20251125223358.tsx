...
export default function Hero() {
  ...
  return (
    <section className="relative overflow-hidden w-full bg-gradient-to-br from-orange-50 via-white to-amber-50">
      ...
      <div className="relative container mx-auto px-4 md:px-6 lg:px-8 xl:px-16 py-12 md:py-14 lg:py-16">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-center">
          {/* Left column: Content */}
          <div className="flex flex-col justify-center animate-fade-in-up">
            <div className="space-y-5 md:space-y-6">
              {/* Enhanced Badge with animation */}
              <div className="inline-flex items-center gap-2 px-5 py-2.5 rounded-full bg-white/80 backdrop-blur-md border border-orange-200/50 shadow-xl w-fit hover:shadow-2xl hover:scale-105 transition-all duration-300 group">
                <div className="relative">
                  <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="text-orange-600 group-hover:scale-110 transition-transform">
              ...
              <h1 className="font-display text-4xl sm:text-5xl lg:text-5xl xl:text-6xl font-bold leading-[1.1] text-gray-900 tracking-tight">
                Pool Orders,{' '}
                <span className="relative inline-block mt-2">
                  ...
                  <span className="absolute bottom-2 left-0 w-full h-4 bg-gradient-to-r from-orange-400/30 to-amber-400/30 -z-0 transform -skew-x-12"></span>
                  <svg className="absolute -right-8 -top-4 w-10 h-10 text-orange-400 opacity-20 animate-bounce-slow" fill="currentColor" viewBox="0 0 20 20">
              ...
              <p className="text-base md:text-lg text-gray-600 max-w-xl leading-relaxed font-medium">
                Meet minimum order quantities together. Access <span className="text-orange-600 font-semibold">wholesale prices</span> without buying in bulk.
              </p>
              ...
              <div className="flex flex-col sm:flex-row gap-3 pt-3">
                <Link 
                  href="#pools" 
                  className="group relative inline-flex items-center justify-center gap-2 bg-gradient-to-r from-orange-500 via-orange-600 to-orange-500 bg-size-200 bg-pos-0 hover:bg-pos-100 text-white px-7 py-3.5 rounded-xl font-semibold text-base shadow-xl hover:shadow-2xl hover:shadow-orange-500/50 transition-all duration-300 hover:scale-105 overflow-hidden"
                >
                ...
                <Link 
                  href="#how-it-works" 
                  className="group inline-flex items-center justify-center gap-2 bg-white/90 backdrop-blur-sm text-gray-900 px-7 py-3.5 rounded-xl font-semibold text-base border-2 border-gray-200 hover:border-orange-500 hover:bg-orange-50 transition-all duration-300 shadow-lg hover:shadow-xl hover:scale-105"
                >
                  <span>How It Works</span>
                  <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="opacity-50 group-hover:opacity-100 transition-opacity">
            ...
            <form onSubmit={onSearch} className="mt-8 lg:mt-10 max-w-xl">
              <div className="relative group">
                ...
                <div className="relative flex items-stretch gap-2 bg-white rounded-2xl shadow-xl p-2 border border-gray-200 group-focus-within:border-orange-300 transition-all">
                  ...
                  <input
                    ...
                    className="flex-1 rounded-xl px-3 py-3.5 text-base md:text-lg text-gray-900 placeholder:text-gray-400 focus:outline-none bg-transparent"
                    placeholder="Search products, suppliers, categories…"
                  />
                  <button 
                    type="submit"
                    className="rounded-xl px-6 py-3 bg-gradient-to-r from-orange-500 to-orange-600 text-white font-semibold hover:from-orange-600 hover:to-orange-700 transition-all shadow-lg hover:shadow-xl hover:scale-105 text-base md:text-lg whitespace-nowrap"
                  >
                    Search
                  </button>
                </div>
              ...
              <div className="mt-5 flex flex-wrap items-center gap-2.5">
                ...
                {['keyboard kit', 'artisan keycaps', 'desk mat', 'switch lubing kit'].map(t => (
                  <button
                    ...
                    type="button"
                    onClick={() => setQ(t)}
                    className="px-4 py-2 rounded-full bg-white/80 backdrop-blur-sm text-gray-700 hover:bg-gradient-to-r hover:from-orange-50 hover:to-amber-50 hover:text-orange-600 hover:border-orange-300 text-sm font-medium border border-gray-200 transition-all shadow-sm hover:shadow-md hover:scale-105"
                  >
                    {t}
                  </button>
                ))}
          ...
          <div className="order-first lg:order-none flex items-center justify-center lg:justify-end animate-fade-in-up animation-delay-300">
            <div className="relative w-full max-w-[500px] px-4 lg:px-0">
              {/* Enhanced glow effect with multiple layers */}
              <div className="absolute inset-0 bg-gradient-to-br from-orange-400/30 via-amber-400/20 to-pink-400/30 rounded-3xl blur-3xl -z-10 animate-pulse-slow"></div>
              <div className="absolute inset-0 bg-gradient-to-tl from-orange-300/20 to-amber-300/20 rounded-3xl blur-2xl -z-10"></div>
              <HeroCarousel items={slides} className="relative w-full h-[350px] md:h-[420px] lg:h-[450px] shadow-2xl rounded-2xl" />
            </div>
          </div>
        </div>
      </div>
