...
## External listings (Alibaba / AliExpress / 1688)
...
Endpoints:
- `GET /api/external/search?platform=ALIBABA|ALIEXPRESS|C1688&q=term&limit=60`
- `GET /api/external/aggregate?platform=ALL|ALIBABA|ALIEXPRESS|C1688&q=term&offset=0&limit=100&minPrice=&maxPrice=&minMoq=&maxMoq=`
