...
// Use test mode key for testing - replace sk_live with sk_test
const stripeKey = process.env.STRIPE_SECRET_KEY?.replace('sk_live_', 'sk_test_') || process.env.STRIPE_TEST_SECRET_KEY;
console.log(`🔑 Using Stripe key: ${stripeKey?.substring(0, 14)}...\n`);
