...
## External listings (Alibaba / AliExpress / 1688 / Taobao / Made-in-China)
...
Endpoints:
- `GET /api/external/search?platform=ALIBABA|ALIEXPRESS|C1688|TAOBAO|MADE_IN_CHINA&q=term&limit=60`
- `GET /api/external/aggregate?platform=ALL|ALIBABA|ALIEXPRESS|C1688|TAOBAO|MADE_IN_CHINA&q=term&offset=0&limit=100&minPrice=&maxPrice=&minMoq=&maxMoq=`
