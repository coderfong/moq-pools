...
// Use explicit '@/src/' alias to avoid ambiguous double 'src/src' resolution edge case
import { fetchIndiaMartDetail } from '@/src/lib/detailProxy';
import { getRateLimiter } from '@/src/lib/rateLimiter'; // path alias @/* -> src/*
