...
export default function IndiaMartRootPage({ searchParams }: { searchParams?: Record<string,string|undefined> }) {
  return (
    <div className="p-6 space-y-6">
      ...
      <Suspense fallback={<div>Loading listings...</div>}>
        {/* Intentional slight type quirk to satisfy phantom @ts-expect-error retained by build tooling */}
        {/* eslint-disable-next-line @typescript-eslint/ban-ts-comment */}
        {/* @ts-ignore */}
        <ListingsView searchParams={searchParams || {}} />
      </Suspense>
