...
export default async function ListingsView({ searchParams }: { searchParams: Record<string,string|undefined> }) {
  ...
  const GRID_COLS: Record<number, string> = {
    ...
    6: 'grid grid-cols-1 sm:grid-cols-2 md:grid-cols-6 lg:grid-cols-6',
    7: 'grid grid-cols-1 sm:grid-cols-2 md:grid-cols-7 lg:grid-cols-7',
    8: 'grid grid-cols-1 sm:grid-cols-2 md:grid-cols-8 lg:grid-cols-8',
  };
