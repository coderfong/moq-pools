        ...
        {listings.map(l => {
          ...
          return (
            <li key={l.id} className="border rounded-2xl p-3 bg-white dark:bg-gray-900 border-gray-200 dark:border-gray-800 shadow-card hover:shadow-lg transition hover:-translate-y-0.5 flex flex-col">
              ...
              <a href={l.url} target="_blank" rel="noopener noreferrer" className="font-medium text-sm line-clamp-2 mt-0.5 text-gray-900 dark:text-gray-100 hover:underline">{l.title}</a>
              <div className="mt-1 text-lg font-semibold text-orange-600">{priceText || 'See listing'}</div>
