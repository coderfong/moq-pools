...
export default function LoginPage() {
    ...
    <main className="min-h-screen">
      ...
      >
        ...
        <div className="absolute inset-0 -z-10 pointer-events-none">
          <Image src={bg} alt="" fill priority className="object-cover object-left scale-100" />
        </div>
  ...
  <div className="order-1 lg:order-2 lg:col-span-5 xl:col-span-4 px-8 md:px-12 py-10 md:py-12 self-center justify-self-center w-full max-w-[420px]">
            <header className="mb-8">
              <h1 className="text-3xl md:text-4xl font-display font-bold text-center bg-gradient-to-r from-white via-orange-100 to-amber-100 bg-clip-text text-transparent drop-shadow-lg">
                Sign in
              </h1>
              <p className="text-base text-white/90 mt-2 text-center font-medium drop-shadow">
