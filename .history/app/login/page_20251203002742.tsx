...
export default function LoginPage() {
  ...
  <div className="order-1 lg:order-2 lg:col-span-6 xl:col-span-5 px-3 sm:px-8 md:px-12 py-3 sm:py-10 md:py-12 self-center justify-self-center w-full max-w-[520px]">
            <header className="mb-3 sm:mb-10">
              <h1 className="text-xl sm:text-4xl md:text-5xl font-display font-bold text-center bg-gradient-to-r from-white via-orange-100 to-amber-100 bg-clip-text text-transparent drop-shadow-lg">
                Sign in
              </h1>
              <p className="text-xs sm:text-lg text-white/90 mt-1 sm:mt-3 text-center font-medium drop-shadow">
            ...
            <form
              onSubmit={onSubmit}
              className="bg-gradient-to-br from-white/95 to-orange-50/90 dark:bg-gradient-to-br dark:from-gray-900/80 dark:to-gray-800/70 backdrop-blur-xl rounded-xl sm:rounded-3xl border-2 border-orange-200/50 p-3 sm:p-8 md:p-10 space-y-2 sm:space-y-6 shadow-2xl"
            >
              <div>
              ...
              <div>
                <div className="flex items-center justify-between mb-0.5 sm:mb-2">
                  ...
                  <Link
                    href="/forgot"
                    className="text-[10px] sm:text-sm text-orange-600 hover:text-orange-700 font-semibold hover:underline"
                  >
                    Forgot password?
                  </Link>
                </div>
