...
export default function LoginPage() {
  ...
  <div className="order-1 lg:order-2 lg:col-span-6 xl:col-span-5 px-8 md:px-12 py-10 md:py-12 self-center justify-self-center w-full max-w-[520px]">
            ...
            <form
              onSubmit={onSubmit}
              className="bg-gradient-to-br from-white/95 to-orange-50/90 dark:bg-gradient-to-br dark:from-gray-900/80 dark:to-gray-800/70 backdrop-blur-xl rounded-3xl border-2 border-orange-200/50 p-8 md:p-10 space-y-6 shadow-2xl"
            >
              <div>
