...
export default function LoginPage() {
  ...
  // Decode the next parameter to handle URL encoding
  const next = decodeURIComponent(searchParams.get('next') || '/products');
  ...
  async function onSubmit(e: React.FormEvent<HTMLFormElement>) {
    ...
    try {
      ...
      // Force a full page reload to ensure the cookie is sent with the request
