...
function EditModal({ alert, onClose, onSave }: { alert: any, onClose: () => void, onSave: (patch: { id: string, title?: string, body?: string, link?: string|null, adminNotes?: string, priority?: boolean }) => void }) {
  ...
  async function handleSave() {
    setSaving(true);
    try {
  await onSave({ id: alert.id, title, body, link: link || null, adminNotes, priority });
    } finally {
      setSaving(false);
    }
  }
