...
export default async function AdminMessagesPage() {
  ...
  const formattedConversations = conversationsWithMessages.map((conv: any) => {
    ...
    const needsReply = lastMessage ? lastMessage.user.role !== 'ADMIN' : false;
    ...
    return {
      ...
      lastMessage: lastMessage ? {
        ...
        senderName: lastMessage.user.name || lastMessage.user.email,
        isAdmin: lastMessage.user.role === 'ADMIN',
      } : null,
