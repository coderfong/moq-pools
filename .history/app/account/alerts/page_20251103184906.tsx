  ...
  return (
    <section className="min-h-screen w-full bg-gradient-to-b from-orange-50/30 to-white">
      <div className="mx-auto flex-1 w-full max-w-[1600px] px-4 sm:px-6 lg:px-8 py-6 min-h-0">
        <div className="grid grid-cols-[160px_280px_1fr] lg:grid-cols-[180px_320px_1fr] border-2 border-orange-200/50 rounded-2xl overflow-hidden shadow-lg bg-white">
          {/* Left: View */}
