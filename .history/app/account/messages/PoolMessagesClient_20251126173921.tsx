      ...
      <div className="mx-auto h-full max-w-[1400px] grid grid-cols-[360px_1fr] border-x border-neutral-200 bg-white">
        ...
        <main className="flex flex-col bg-white">
          {activePool && activeConversation ? (
            <>
              {/* Chat Header */}
              <div className="p-4 border-b-2 border-gray-200 bg-gradient-to-r from-emerald-50 to-white">
                <div className="flex items-center gap-3">
                  ...
                  <div className="flex-1">
                    ...
                    <div className="flex items-center gap-2 text-xs text-gray-600">
                      ...
                      <span>•</span>
                      <span>{activePool.pledgedQty}/{activePool.targetQty} units committed</span>
                    </div>
                  </div>
                  <Link
              ...
              <div className="p-4 border-t-2 border-gray-200 bg-white">
                <div className="flex gap-3">
                  <textarea
                    ...
                    className="flex-1 px-4 py-3 rounded-xl border-2 border-gray-200 focus:border-emerald-500 focus:ring-2 focus:ring-emerald-200 outline-none resize-none"
                    rows={1}
