...
export default function PoolMessagesClient({ userPools: initialPools, userId }: Props) {
    ...
    return (
      <div className="h-full w-full flex items-center justify-center bg-neutral-50">
        <div className="text-center p-8">
          ...
          <h2 className="text-2xl font-bold text-gray-900 mb-2">No Pool Support Chats</h2>
          <p className="text-gray-600 mb-6">Join a pool to chat with admin support about your orders!</p>
          <Link 
            href="/pools"
  ...
  return (
    <div className="h-full w-full flex">
      {/* Sidebar - Pool List */}
      <aside className="w-[360px] flex flex-col border-r border-neutral-200 bg-white overflow-hidden">
          {/* Header */}
          <div className="p-4 border-b border-neutral-200 bg-gradient-to-r from-emerald-50 to-white">
            <div className="flex items-center gap-2 mb-2">
              <span className="text-2xl">💬</span>
              <h1 className="text-lg font-bold tracking-tight">Pool Support</h1>
            </div>
            <p className="text-xs text-gray-600">Chat with admin about your pools</p>
          </div>
