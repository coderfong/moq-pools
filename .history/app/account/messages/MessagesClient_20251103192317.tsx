...
export default function MessagesClient() {
  ...
  return (
    <section className="h-screen w-full bg-neutral-50 text-neutral-900 flex flex-col">
      ...
      {mode === 'alerts' ? (
        <div className="flex-1 w-full px-8 min-h-0 grid grid-cols-[140px_240px_1fr] lg:grid-cols-[160px_260px_1fr] border-2 border-blue-200/50 rounded-2xl overflow-hidden shadow-lg bg-white">
