...
export default function MessagesClient() {
  ...
  return (
    <section className="h-screen w-screen -ml-4 -mr-4 md:-ml-6 md:-mr-6 lg:-ml-8 lg:-mr-8 xl:-ml-16 xl:-mr-16 bg-neutral-50 text-neutral-900 flex flex-col">
      {/* Top toggle */}
      <div className="mx-auto w-full max-w-none px-8 py-3 flex items-center justify-between text-gray-900">
        <h1 className="text-xl font-bold bg-gradient-to-r from-gray-900 to-blue-600 bg-clip-text text-transparent">Messages</h1>
      </div>

      {mode === 'alerts' ? (
        <div className="mx-auto flex-1 w-full max-w-none px-8 min-h-0 grid grid-cols-[140px_240px_1fr] lg:grid-cols-[160px_260px_1fr] border-2 border-blue-200/50 rounded-2xl overflow-hidden shadow-lg bg-white">
      ...
      <div className="mx-auto flex-1 w-full max-w-[1800px] px-4 sm:px-6 lg:px-8 min-h-0 grid grid-cols-[140px_240px_1fr] lg:grid-cols-[160px_260px_1fr] border-2 border-blue-200/50 rounded-2xl overflow-hidden shadow-lg bg-white">
        {/* Far-left: Mode selector */}
        <aside className="min-h-0 border-r-2 border-blue-200/30 bg-gradient-to-b from-blue-50/20 to-white p-4">
          <div className="space-y-3">
            <div>
