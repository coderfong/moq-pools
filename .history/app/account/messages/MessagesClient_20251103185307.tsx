...
export default function MessagesClient() {
  ...
  return (
    <section className="h-screen w-full bg-neutral-50 text-neutral-900 flex flex-col">
      ...
      <div className="mx-auto flex-1 w-full max-w-[1600px] px-4 sm:px-6 lg:px-8 min-h-0 grid grid-cols-[160px_260px_1fr] lg:grid-cols-[180px_280px_1fr] border-2 border-blue-200/50 rounded-2xl overflow-hidden shadow-lg bg-white">
        {/* Far-left: Mode selector */}
        <aside className="min-h-0 border-r-2 border-blue-200/30 bg-gradient-to-b from-blue-50/20 to-white p-4">
          <div className="space-y-3">
            <div>
