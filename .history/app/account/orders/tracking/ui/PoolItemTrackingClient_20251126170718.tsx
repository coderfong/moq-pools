...
export default function OrderTrackingClient({ poolItems: initialItems }: OrderTrackingClientProps) {
  ...
  const selectedItemData = useMemo(() => {
    const data = selectedItem 
      ...
      : null;
    console.log('selectedItemData computed:', { selectedItem, data: !!data, showHistory });
    return data;
  }, [selectedItem, poolItems, showHistory]);
  ...
  console.log('Render - showHistory:', showHistory, 'selectedItem:', selectedItem, 'selectedItemData:', !!selectedItemData);
    ...
    <div className="flex flex-col gap-6 p-6">
      ...
      {showHistory && (
        <div className="bg-yellow-100 border-2 border-yellow-500 p-4 rounded">
          Debug: showHistory={String(showHistory)}, selectedItem={selectedItem}, hasData={String(!!selectedItemData)}
        </div>
      )}
            ...
            return (
              <motion.div
                ...
                onClick={(e) => {
                  ...
                  setShowHistory(true);
                  console.log('State updated - selectedItem:', item.id, 'showHistory:', true);
                }}
              >
                <div className="p-6">
