  ...
  const [poolItems] = useState<PoolItem[]>(
    initialItems.map(item => ({
      ...
      shipment: item.shipment ? {
        ...item.shipment,
        shippedAt: item.shipment.shippedAt ? new Date(item.shipment.shippedAt) : null,
        deliveredAt: item.shipment.deliveredAt ? new Date(item.shipment.deliveredAt) : null
      } : null,
              ...
              <div className="p-6 overflow-y-auto max-h-[calc(90vh-200px)]">
                ...
                <div className="mb-8">
                  ...
                  <div className="flex items-center justify-between relative">
                    ...
                    <div 
                      className="absolute top-5 left-0 h-1 bg-gradient-to-r from-emerald-400 to-emerald-600 -z-10 transition-all duration-500"
                      data-progress={(MILESTONE_STATUSES.indexOf(selectedItemData.poolItemStatus) / (MILESTONE_STATUSES.length - 1)) * 100}
                    />
                  ...
                  {selectedItemData.payment && (
                    <div className="p-4 rounded-xl bg-green-50 border-2 border-green-200">
                      ...
                      <div className="text-lg font-bold text-green-900">
                        ${selectedItemData.payment.amount.toFixed(2)}
                      </div>
