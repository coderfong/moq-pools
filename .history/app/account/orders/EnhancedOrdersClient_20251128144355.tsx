                ...
                <div className="p-6">
                  <div className="flex flex-col md:flex-row gap-6">
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      {/* Order Timeline - Pool Progress */}
                      <div className="mt-4 space-y-2">
                        <div className="flex items-center justify-between text-xs text-gray-600">
                          <span>Pool Progress</span>
                          <span className="font-medium">
                            {order.pool?.pledgedQty || 0} / {order.pool?.targetQty || 0} units
                            {order.pool?.targetQty && order.pool.pledgedQty >= order.pool.targetQty && (
                              <span className="ml-1 text-green-600">✓ MOQ Met</span>
                            )}
                          </span>
                        </div>
                        <div className="flex-1 bg-gray-200 rounded-full h-2 overflow-hidden">
                          <div
                            ...
                            style={{
                              width: `${Math.min(100, Math.round(((order.pool?.pledgedQty || 0) / (order.pool?.targetQty || 1)) * 100))}%`
                            }}
                          ></div>
                        </div>
                      </div>
