                ...
                return (
                  <RevealItem key={keyFromListing(it, idx)}>
                    ...
                    <div className="group relative h-full">
                      ...
                      <div className="relative rounded-2xl overflow-hidden bg-white/98 backdrop-blur-sm border-2 border-orange-200/50 shadow-lg hover:shadow-2xl hover:shadow-orange-500/15 transition-all duration-300 hover:-translate-y-2 min-h-[500px] sm:min-h-[600px] flex flex-col h-full">
                      ...
                      <Link href={savedId ? `/pools/${savedId}` : (it.url || '#')} className="block flex-1 flex flex-col p-6 pb-4">
                        {(() => {
                          ...
                          return (
                            <div className="relative h-40 sm:h-48 lg:h-52 bg-gradient-to-br from-orange-50 via-amber-50 to-orange-50 rounded-xl mb-3 overflow-hidden border border-orange-100/60 shadow-sm">
                        ...
                        <div className="h-14 sm:h-16 font-bold text-xs sm:text-sm text-gray-900 line-clamp-3 mb-2 sm:mb-3 leading-tight overflow-hidden" title={title}>{title || 'See listing'}</div>
                        {(() => {
                          const primary = it.price && it.price.toString().trim().length ? it.price : '';
                          let display = primary;
                          ...
                          return (
                            <div className="h-8 sm:h-10 flex items-baseline gap-1 sm:gap-2 mb-2 sm:mb-3">
                              <div className="text-base sm:text-xl font-extrabold bg-gradient-to-r from-orange-600 via-orange-500 to-amber-500 bg-clip-text text-transparent">
                        ...
                        <div className="h-5 sm:h-6 lg:h-8 mb-1 sm:mb-1.5 flex items-center">
                          <SyncedCountdown size="md" variant="accent" showIcon={true} />
                        </div>
                      </Link>
                      {/* Enhanced CTA row (sibling to avoid nested links) */}
                      <div className="p-3 sm:p-4 lg:p-6 pt-3 sm:pt-4 flex flex-col sm:flex-row sm:flex-wrap items-stretch sm:items-center gap-2 sm:gap-3 mt-auto border-t border-gray-100/60">
                        <a 
                          href={it.url || '#'} 
                          target="_blank" 
                          rel="noreferrer" 
                        ...
                        {it.url && ((it.url as string).includes('alibaba.com') || (it.url as string).includes('made-in-china.com') || (it.url as string).includes('indiamart.com')) ? (
                          <DetailLink url={String(it.url)} title={title} className="w-full sm:flex-1 sm:min-w-[90px] px-3 sm:px-4 py-2 sm:py-3 rounded-xl border border-orange-200/60 hover:border-orange-500 hover:bg-gradient-to-br hover:from-orange-50 hover:to-amber-50 transition-all duration-300 text-xs sm:text-sm font-bold text-gray-700 hover:text-orange-600 hover:shadow-lg text-center" />
                        ) : (
                          <a href={it.url || '#'} target="_blank" rel="noreferrer" className="w-full sm:flex-1 sm:min-w-[90px] px-3 sm:px-4 py-2 sm:py-3 rounded-xl border border-orange-200/60 hover:border-orange-500 hover:bg-gradient-to-br hover:from-orange-50 hover:to-amber-50 transition-all duration-300 text-xs sm:text-sm font-bold text-gray-700 hover:text-orange-600 hover:shadow-lg text-center">
                            Details
                          </a>
                        )}
                        <ProductCardButtons
