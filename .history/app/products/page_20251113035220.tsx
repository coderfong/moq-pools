                            ...
                            return (
                              <div className="mb-4 space-y-2">
                                ...
                                <div className="relative h-2.5 bg-gradient-to-r from-gray-100 to-gray-200 rounded-full overflow-hidden border border-gray-300/50">
                                    <div 
                                      className={`h-full bg-gradient-to-r from-emerald-500 via-emerald-400 to-emerald-500 transition-all duration-500 rounded-full shadow-lg shadow-emerald-500/30 w-[${percent}%]`} 
                                    />
                                </div>
                              </div>
                            );
