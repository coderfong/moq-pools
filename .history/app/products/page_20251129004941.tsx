                ...
                return (
                  <RevealItem key={keyFromListing(it, idx)}>
                    ...
                    <div className="group relative h-full">
                      ...
                      <div className="relative rounded-2xl overflow-hidden bg-white/95 backdrop-blur-sm border-2 border-orange-200/40 shadow-lg hover:shadow-2xl hover:shadow-orange-500/10 transition-all duration-300 hover:-translate-y-2 h-[520px] flex flex-col">
                      {/* Main clickable block - now goes to pool page */}
                      <Link href={savedId ? `/pools/${savedId}` : (it.url || '#')} className="block flex-1 flex flex-col p-5">
                        {(() => {
                          ...
                          return (
                            <div className="relative h-48 bg-gradient-to-br from-orange-50 via-amber-50 to-orange-50 rounded-xl mb-4 overflow-hidden border-2 border-orange-100/50">
                        ...
                        <div className="h-4 text-xs text-gray-500 truncate mb-3 font-medium flex items-center" title={it.storeName || ''}>{it.storeName || 'Store'}</div>
                        <div className="h-16 font-bold text-sm text-gray-900 line-clamp-3 mb-4 leading-snug overflow-hidden" title={title}>{title || 'See listing'}</div>
                        {(() => {
                          const primary = it.price && it.price.toString().trim().length ? it.price : '';
                          let display = primary;
                          ...
                          return (
                            <div className="h-8 flex items-baseline gap-2 mb-4">
                        ...
                        {(() => {
                          try {
                            ...
                            return (
                              <div className="h-14 mb-4 space-y-2">
                      ...
                      <div className="p-5 pt-0 flex flex-wrap items-center gap-3 mt-auto">
                        <a 
                          href={it.url || '#'} 
                          target="_blank" 
                          rel="noreferrer" 
