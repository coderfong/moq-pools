  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 via-white to-orange-50/30">
      ...
      <div className="container mx-auto px-4 md:px-6 lg:px-8 xl:px-16 py-6 space-y-6">
        {/* Header Section */}
        <RevealSection className="sticky top-[72px] z-20 bg-white/90 backdrop-blur-lg border-b border-gray-200 -mx-4 md:-mx-6 lg:-mx-8 xl:-mx-16 px-4 md:px-6 lg:px-8 xl:px-16 py-4 shadow-sm">
          <div className="flex items-center justify-between">
            <h1 className="text-3xl lg:text-4xl font-bold bg-gradient-to-r from-gray-900 via-gray-800 to-orange-600 bg-clip-text text-transparent">
              MOQ Pools
            </h1>
            <div className="hidden md:block">
              <div className="inline-flex items-center gap-2 bg-orange-50 text-orange-600 px-4 py-2 rounded-full text-sm font-semibold border border-orange-200">
                  ...
                  <RevealItem key={keyFromListing(it, idx)}>
                    <div className="rounded-2xl p-3 bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 shadow-card hover:shadow-lg transition hover:-translate-y-0.5 transform will-change-transform h-full flex flex-col">
                      ...
                      <a href={it.url || '#'} target="_blank" rel="noreferrer" className="block flex-1 flex flex-col">
                        ...
                        <div className="font-medium text-sm mt-0.5 text-gray-900 dark:text-gray-100">{title || 'See listing'}</div>
                        {(() => {
