                    ...
                    <div className="group relative h-full">
                      ...
                      <LinkComponent {...linkProps} className="block flex-1 flex flex-col p-4">
                        ...
                        {(() => {
                          ...
                          // If we have price tiers, compute the full price range
                          if (tiers.length > 1) {
                            // Extract all prices from tiers
                            const prices: number[] = [];
                            for (const tier of tiers) {
                              const priceText = tier.priceText || '';
                              // Extract numeric price from text like "US$318" or "$313"
                            ...
                            display = display || tiers[0]?.priceText || '';
                          }
