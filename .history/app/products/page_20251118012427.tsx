    ...
    if (FAST) {
      ...
      pageItems = await Promise.all(pageItems.map(async (it: any) => {
        ...
        try {
          ...
          console.log('[ENRICHMENT FAST] Processing:', it.title?.substring(0, 40), 'detailJson:', !!detailJson, 'priceTiers:', detailJson?.priceTiers?.length);
          if (detailJson && Array.isArray(detailJson.priceTiers) && detailJson.priceTiers.length) {
            ...
            console.log('[ENRICHMENT FAST] Converted tiers:', tiers.length);
          }
        } catch {}
