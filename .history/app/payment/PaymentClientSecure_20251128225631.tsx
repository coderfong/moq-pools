...
export default function PaymentClientSecure() {
  ...
  const subtotal = parseFloat(searchParams.get('subtotal') || searchParams.get('amount') || '0');
  const shipping = parseFloat(searchParams.get('shipping') || '0');
  const shippingZone = searchParams.get('shippingZone') || 'domestic';
          ...
          <div className="rounded-3xl border-2 border-orange-200/60 bg-gradient-to-br from-white via-orange-50/10 to-amber-50/20 p-8 shadow-2xl sticky top-6 backdrop-blur-sm">
            ...
            <div className="mt-8 space-y-4 text-sm">
              ...
              <div className="flex items-center justify-between py-2">
                ...
                <span className="text-neutral-900 font-bold text-base">{quantity} units</span>
              </div>
              
              <div className="flex items-center justify-between py-2">
                <span className="text-neutral-600 font-medium">Unit Price</span>
                <span className="text-neutral-900 font-bold text-base">{formatCurrency(subtotal / quantity)}</span>
              </div>
              ...
              <div className="flex items-center justify-between py-2 border-b border-orange-100">
                ...
                <span className="text-neutral-900 font-bold text-base">{formatCurrency(subtotal)}</span>
              </div>
              ...
              <div className="flex items-center justify-between py-2">
                <span className="text-neutral-600 font-medium flex items-center gap-1">
                  ...
                  Shipping ({shippingZone === 'domestic' ? '🇺🇸 Domestic' : shippingZone === 'canada' ? '🇨🇦 Canada' : '🌍 International'})
                </span>
            ...
            <div className="mt-8 space-y-3 text-xs bg-gradient-to-br from-green-50 to-emerald-50 rounded-2xl p-5 border-2 border-green-200 shadow-inner">
              <div className="flex items-start gap-3">
                ...
                <div>
                  <p className="font-bold text-green-900">Secure Escrow Protection</p>
                  <p className="text-green-700 mt-1">Funds held safely until MOQ is met</p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  <p className="font-bold text-green-900">Smart Payment Capture</p>
                  <p className="text-green-700 mt-1">Charged only when pool is complete</p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  <p className="font-bold text-green-900">PCI-DSS Level 1 Certified</p>
                  <p className="text-green-700 mt-1">Bank-grade encryption via Stripe</p>
                </div>
              </div>
            </div>
          </div>
