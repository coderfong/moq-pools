            ...
            {clientSecret && !loading && !error && stripePromise && (
              <div className="mt-8">
                <div className="mb-4 p-3 bg-blue-50 border border-blue-200 rounded text-xs">
                  ...
                  <p className="text-blue-700">Client Secret: {clientSecret ? 'Present ✓' : 'Missing ✗'}</p>
                  <p className="text-blue-700">Stripe Promise: {stripePromise ? 'Loaded ✓' : 'Not loaded ✗'}</p>
                  <p className="text-blue-700">Publishable Key: {process.env.NEXT_PUBLIC_STRIPE_PUBLISHABLE_KEY ? 'Set ✓' : 'Missing ✗'}</p>
                </div>
