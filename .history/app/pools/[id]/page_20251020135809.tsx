              ...
              <div class="mt-2 text-black">
                ...
                <div class="mt-3">
                  <div id="pricing-progress"
                       class="relative h-2 w-[320px] overflow-hidden rounded-full border border-gray-200 bg-gray-100"
                  ...
                  <div class="mt-1 flex justify-between text-[12px] text-gray-500 w-[320px]">
