          ...
          <div class="pool-hero grid grid-cols-1 md:grid-cols-[360px_1fr] gap-6 items-start">
            <div class="pool-hero-left">
              ...
              <div class="mt-3 flex justify-center">
                <a href="/join/${esc(id)}" class="inline-flex items-center justify-center rounded-full font-semibold btn-mag btn-primary-gradient shadow-card hover:shadow-lg text-lg px-6 py-3.5">Join Pool</a>
              </div>
            </div>
