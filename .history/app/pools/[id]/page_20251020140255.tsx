...
export default async function PoolDetailPage({ params, searchParams }: { params: { id: string }, searchParams?: { [key: string]: string | string[] | undefined } }) {
  ...
  const html = `
         ...
         <div id="pricing-progress"
           class="relative h-2 w-[480px] overflow-hidden rounded-full border border-gray-200 bg-gray-100"
                  ...
                  <div class="mt-1 flex justify-between text-[12px] text-gray-500 w-[480px]">
