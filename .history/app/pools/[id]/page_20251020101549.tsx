  ...
  const html = `
          <div class="pool-hero grid grid-cols-1 md:grid-cols-[360px_1fr] gap-6 items-start">
            <div class="pool-hero-left">
              ...
              <div class="mt-3">
                <a href="/join/${esc(id)}" class="w-full inline-flex items-center justify-center rounded-full font-medium btn-mag btn-primary-gradient shadow-card hover:shadow-lg text-sm px-4 py-2">Join Pool</a>
              </div>
            </div>
