        ...
        <div className="pool-hero grid grid-cols-1 md:grid-cols-[420px_1fr] gap-10 items-start" data-source-url={listing.url || ''}>
          <div className="pool-hero-left">
            ...
            <div className="mt-6 flex flex-col items-center gap-4">
              <a href="http://localhost:3007/products" className="inline-flex items-center justify-center rounded-2xl font-bold btn-mag text-2xl px-10 py-5 w-full text-white">
