          ...
          <div class="pool-hero grid grid-cols-1 md:grid-cols-[420px_1fr] gap-10 items-start" data-source-url="${listing.url ? esc(String(listing.url)) : ''}">
            ...
            <div class="pool-hero-right min-w-0" data-source-url="${listing.url ? esc(String(listing.url)) : ''}">
              <div class="flex items-start justify-between gap-4 mb-4">
                ...
                <div id="pool-timer-placeholder"></div>
              </div>
  ...
  return (
    <div className="px-6 md:px-10 xl:px-16 py-6">
      ...
      <div className="rounded-2xl border border-gray-200 bg-white p-4 overflow-x-auto">
        ...
        {/* Inject timer component into placeholder */}
        <script
      ...
      <div className="hidden" data-timer-target="pool-timer-placeholder">
        <PoolTimer deadline={timerDeadlineISO} />
      </div>
