...
export default function PoolTimer({ deadline }: { deadline: string }) {
  ...
  // Show placeholder during SSR to match client render
  if (!mounted) {
    return (
      <div className="text-base md:text-lg text-gray-900 flex-shrink-0">
        <span className="inline-flex items-center gap-2 rounded-2xl border-3 border-orange-300 bg-gradient-to-r from-orange-100 to-amber-100 px-6 py-3 font-bold shadow-lg">
