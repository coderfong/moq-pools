...
export default function PoolsClient({ pools, initialStatus, initialSort, initialView }: PoolsClientProps) {
  ...
  return (
    <div className="max-w-7xl mx-auto px-2 sm:px-4 py-4 sm:py-8">
      {/* Header */}
      <div className="mb-8">
        <h1 className="text-xl sm:text-2xl md:text-3xl font-bold text-gray-900 mb-1 sm:mb-2">Active Pools</h1>
        <p className="text-sm sm:text-base text-gray-600">Join group buying pools to unlock wholesale pricing</p>
      </div>

      {/* Filters & Controls */}
      <div className="bg-white border border-gray-200 rounded-lg sm:rounded-xl p-2 sm:p-4 mb-4 sm:mb-6">
        <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-2 overflow-x-auto">
            ...
            {[
              ...
              <button
                ...
                className={`px-2 sm:px-3 md:px-4 py-1 sm:py-1.5 md:py-2 rounded-md sm:rounded-lg text-xs sm:text-sm font-medium whitespace-nowrap transition-colors ${
          ...
          <div className="flex items-center gap-2">
            ...
            <select
              ...
              className="px-2 sm:px-3 md:px-4 py-1 sm:py-1.5 md:py-2 border border-gray-300 rounded-md sm:rounded-lg text-xs sm:text-sm focus:ring-2 focus:ring-orange-500 focus:border-transparent"
              title="Sort by"
            >
            ...
            return (
              ...
              >
                ...
                <div className="p-4 space-y-3">
                  <h3 className="text-sm sm:text-base font-semibold text-gray-900 line-clamp-2 group-hover:text-orange-600 transition-colors min-h-[2.5rem] sm:min-h-[3rem]">
                    {pool.title}
                  </h3>
