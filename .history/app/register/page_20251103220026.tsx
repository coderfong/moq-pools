...
export default function RegisterPage() {
    ...
    <main className="min-h-screen">
      ...
      >
        ...
        <div className="absolute inset-0 -z-10 pointer-events-none">
          <Image src={BG_URL} alt="" fill priority className="object-cover object-left" />
        </div>
  ...
  <div className="order-2 lg:order-1 lg:col-span-6 xl:col-span-7" />
        ...
        {/* Right side: form */}
  <div className="order-1 lg:order-2 lg:col-span-6 xl:col-span-5 px-8 md:px-12 py-4 md:py-6 self-center justify-self-center w-full max-w-[540px] transform translate-x-2 md:translate-x-3">
          ...
          <form
            ...
            className="bg-gradient-to-br from-white/95 to-orange-50/90 dark:bg-gradient-to-br dark:from-gray-900/80 dark:to-gray-800/70 backdrop-blur-xl rounded-3xl border-2 border-orange-200/50 p-10 md:p-12 space-y-6 shadow-2xl"
          >
            <div>
