...
export default function RegisterPage() {
    ...
    <main className="min-h-screen">
      ...
      >
        ...
        <div className="absolute inset-0 -z-10 pointer-events-none">
          <Image src={BG_URL} alt="" fill priority className="object-cover object-left scale-100" />
        </div>
  ...
  <div className="order-2 lg:order-1 lg:col-span-7 xl:col-span-8" />
        ...
        {/* Right side: form */}
  <div className="order-1 lg:order-2 lg:col-span-5 xl:col-span-4 px-8 md:px-12 py-4 md:py-6 self-center justify-self-center w-full max-w-[420px] transform translate-x-2 md:translate-x-3">
          <header className="mb-8">
            <h1 className="text-3xl md:text-4xl font-display font-bold text-center bg-gradient-to-r from-white via-orange-100 to-amber-100 bg-clip-text text-transparent drop-shadow-lg">Create account</h1>
            <p className="text-base text-white/90 mt-2 text-center font-medium drop-shadow">Join MOQ Pools. Please enter your details.</p>
          </header>

          <form
            onSubmit={openVerifyModal}
            className="bg-gradient-to-br from-white/95 to-orange-50/90 dark:bg-gradient-to-br dark:from-gray-900/80 dark:to-gray-800/70 backdrop-blur-xl rounded-3xl border-2 border-orange-200/50 p-6 md:p-8 space-y-4 shadow-2xl"
          >
            <div>
            ...
            <div>
              <div className="flex items-center justify-between mb-2">
                ...
                <Link href="/forgot" className="text-sm text-orange-600 hover:text-orange-700 font-semibold hover:underline">
                  Forgot password?
                </Link>
              </div>
            ...
            <div className="ft-form-item-control">
              <div className="ft-form-item-input">
                <label className="ft-checkbox inline-flex items-start gap-2">
                  ...
                  <span className="ft-checkbox-label text-sm text-gray-800 font-medium">
                    <span>
                      I agree to the{' '}
            ...
            <div className="turnstile space-y-2">
              ...
              {siteKey ? (
                ...
                <div className="mt-1 text-xs text-amber-800 font-semibold bg-amber-50 border-2 border-amber-300 rounded-xl p-3">
