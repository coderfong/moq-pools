...
export default function RegisterPage() {
  ...
  <div className="order-2 lg:order-1 lg:col-span-7 xl:col-span-8" />
        ...
        {/* Right side: form */}
  <div className="order-1 lg:order-2 lg:col-span-5 xl:col-span-4 px-8 md:px-12 py-4 md:py-6 self-center justify-self-center w-full max-w-[520px] transform translate-x-2 md:translate-x-3">
...
}50 flex items-center justify-between">
              <div className="flex items-center gap-3">
                <div className="w-10 h-10 rounded-full bg-gradient-to-br from-orange-500 to-amber-500 flex items-center justify-center shadow-lg">
                  <span className="text-white text-xl">✉️</span>
                </div>
