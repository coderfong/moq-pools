...
export default function RegisterPage() {
    ...
    <main className="min-h-screen">
      ...
      >
        ...
        <div className="absolute inset-0 -z-10 pointer-events-none">
          <Image src={BG_URL} alt="" fill priority className="object-cover object-left scale-110" />
        </div>
  ...
  <div className="order-2 lg:order-1 lg:col-span-7 xl:col-span-8" />
        ...
        {/* Right side: form */}
  <div className="order-1 lg:order-2 lg:col-span-5 xl:col-span-4 px-8 md:px-12 py-4 md:py-6 self-center justify-self-center w-full max-w-[480px] transform translate-x-2 md:translate-x-3">
          <header className="mb-10">
            <h1 className="text-4xl md:text-5xl font-display font-bold text-center bg-gradient-to-r from-white via-orange-100 to-amber-100 bg-clip-text text-transparent drop-shadow-lg">Create account</h1>
            <p className="text-lg text-white/90 mt-3 text-center font-medium drop-shadow">Join MOQ Pools. Please enter your details.</p>
          </header>

          <form
            onSubmit={openVerifyModal}
            className="bg-gradient-to-br from-white/95 to-orange-50/90 dark:bg-gradient-to-br dark:from-gray-900/80 dark:to-gray-800/70 backdrop-blur-xl rounded-3xl border-2 border-orange-200/50 p-8 md:p-10 space-y-5 shadow-2xl"
          >
            <div>
