...
export default function Home() {
  return (
    <div>
      ...
      <section id="pools" className="relative py-10 sm:py-16 md:py-28 bg-gradient-to-b from-white via-gray-50 to-white overflow-hidden">
        ...
        <div className="container relative mx-auto px-3 sm:px-4 md:px-6 lg:px-8">
          ...
          <div className="text-center max-w-4xl mx-auto mb-8 sm:mb-12 md:mb-20 animate-fade-in-up">
            <div className="inline-flex items-center gap-1.5 sm:gap-2 bg-gradient-to-r from-orange-50 to-amber-50 text-orange-600 px-3 sm:px-4 md:px-5 py-1.5 sm:py-2 md:py-2.5 rounded-full text-xs sm:text-sm font-bold mb-4 sm:mb-6 md:mb-8 shadow-lg border border-orange-100 hover:scale-105 transition-transform">
