      ...
      <div className="mx-auto grid w-full max-w-[1000px] grid-cols-1 gap-6 px-4 py-6 sm:grid-cols-3 sm:py-8">
        ...
        <div className="sm:col-span-1">
          <div className="space-y-4">
            {/* Direct messaging */}
            <div className="rounded-xl border border-neutral-200 bg-white p-4">
              <div className="text-sm font-medium text-neutral-900">Direct messaging</div>
              <div className="mt-2 grid gap-2">
                ...
                <a href="#" className="rounded-md border border-neutral-200 px-3 py-2 text-sm hover:bg-neutral-50" aria-label="WhatsApp link">WhatsApp</a>
                <a href="#" className="rounded-md border border-neutral-200 px-3 py-2 text-sm hover:bg-neutral-50" aria-label="Telegram link">Telegram</a>
