              ...
              return (
                <motion.div key={i} variants={item} className="relative">
                  ...
                  <div className="relative bg-white rounded-3xl shadow-lg hover:shadow-2xl transition-all duration-500 overflow-hidden border-2 border-gray-100 hover:border-orange-200 group">
                    <div className="grid md:grid-cols-[auto_1fr] gap-6 md:gap-8 p-6 md:p-8">
                      {/* Left Side - Number, Icon & Image */}
                      <div className="flex md:flex-col items-center md:items-start gap-4">
                        <div className="relative z-10 w-20 h-20 rounded-2xl bg-gradient-to-br from-orange-500 to-amber-600 flex items-center justify-center shadow-xl group-hover:scale-110 transition-transform flex-shrink-0">
                          <span className="text-3xl font-bold text-white">{i + 1}</span>
                        </div>
                        <div className="w-14 h-14 rounded-xl bg-orange-100 flex items-center justify-center group-hover:bg-orange-200 transition-colors flex-shrink-0">
                          <StepIcon className="w-7 h-7 text-orange-600" />
                        </div>
                        
                        {/* Image */}
                        <div className="hidden md:block mt-4 w-48 h-48 rounded-2xl overflow-hidden shadow-md border-2 border-gray-100">
                          <img 
                            src={step.image} 
                      ...
                      <div className="flex-1">
                        ...
                        {/* Mobile Image */}
                        <div className="md:hidden mb-5 w-full h-48 rounded-2xl overflow-hidden shadow-md border-2 border-gray-100">
                          <img 
                            src={step.image} 
                            alt={`${step.title} illustration`} 
                            className="w-full h-full object-cover"
