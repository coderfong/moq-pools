...
export default function AlibabaAuthManualPage() {
  ...
  // ICBU (Alibaba.com International) OAuth endpoint - from official docs
  const authUrl = `https://openapi-auth.alibaba.com/oauth/authorize?response_type=code&redirect_uri=${encodeURIComponent(redirectUri)}&client_id=${appKey}&site=alibaba`;
