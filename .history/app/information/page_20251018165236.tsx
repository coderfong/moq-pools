  ...
  <div className="order-1 lg:order-2 lg:col-span-7 xl:col-span-6 px-6 md:px-10 py-4 md:py-6 self-center justify-self-center w-full max-w-[640px] transform translate-x-20 md:translate-x-21">
          ...
          <form onSubmit={onSubmit} className="bg-white/85 dark:bg-gray-900/70 backdrop-blur-xl rounded-3xl border border-hairline p-6 md:p-8 space-y-6 shadow-2xl">
            ...
            <div ref={comboRef} className="relative">
              <label htmlFor="country-combobox" className="block text-base font-medium text-black">Country/Region<span className="text-red-600">*</span></label>
              <input
                id="country-combobox"
                role="combobox"
              ...
              {isCountryOpen && (
                <div
                  ...
                  className="absolute z-20 mt-2 max-h-72 w-full overflow-auto rounded-2xl border border-hairline bg-white shadow-xl focus:outline-none"
                >
                  {filteredCountries.length === 0 ? (
                    <div role="option" aria-disabled={true} className="px-4 py-2 text-sm text-gray-500">No matches</div>
                  ) : (
                    filteredCountries.map((c, idx) => (
                      <div
                        ...
                        tabIndex={-1}
                        className={`px-4 py-2 cursor-pointer text-sm flex items-center justify-between ${idx === highlightIndex ? "bg-gray-100" : ""}`}
