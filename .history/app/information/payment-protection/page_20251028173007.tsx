        ...
        <div className="mx-auto w-full max-w-[1000px] px-4 py-8 sm:py-12">
          <div className="flex items-start justify-between gap-4">
            <div className="min-w-0">
              ...
              <div className="mt-3 flex flex-wrap items-center gap-3 text-xs text-neutral-700">
                <span className="inline-flex items-center gap-2 rounded-full border border-neutral-200 bg-white px-2 py-1">
                  ...
                  <span className="inline-flex items-center gap-1">
                    <Image src={stripeLogo} alt="Stripe" width={56} height={20} className="h-5 w-auto" />
                    <Image src={paypalLogo} alt="PayPal" width={56} height={20} className="h-5 w-auto" />
                  </span>
                </span>
