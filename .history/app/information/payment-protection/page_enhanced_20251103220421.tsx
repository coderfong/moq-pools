    ...
    <div className="relative min-h-screen bg-gradient-to-b from-orange-50/30 via-white to-white">
      ...
      <Section id="partners" title="Our payment partners">
        <div className="flex flex-wrap items-center gap-6">
          <Image src={stripeLogo} alt="Stripe" width={100} height={35} className="h-9 w-auto grayscale hover:grayscale-0 transition-all" />
          <Image src={paypalLogo} alt="PayPal" width={100} height={35} className="h-9 w-auto grayscale hover:grayscale-0 transition-all" />
        </div>
