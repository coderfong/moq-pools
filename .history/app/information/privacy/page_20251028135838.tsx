    ...
    <section className="mx-auto w-full max-w-[1000px] px-4 py-8 text-neutral-900">
      ...
      <div className="mt-6 space-y-6 text-sm leading-6 text-neutral-800">
        <section>
          ...
          <p className="mt-2">This Privacy Policy describes how PoolBuy ("we", "us") collects, uses, and protects your information when you use our platform. We operate from Singapore and process data in alignment with applicable laws including PDPA (Singapore), GDPR (EU), and CCPA (US).</p>
        ...
        <section>
          ...
          <p className="mt-2">To exercise your rights or request information deletion, contact us at <a className="underline" href={`mailto:${email}`}>{email}</a>. We’ll respond within a reasonable timeframe and in accordance with applicable laws.</p>
        </section>
      </div>
    </section>
  );
