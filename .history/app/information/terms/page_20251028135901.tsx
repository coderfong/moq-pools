...
export const metadata = {
  title: "Terms of Service | PoolBuy",
  description: "Terms governing use of the PoolBuy platform, group orders, payments, shipping, and refunds.",
};
    ...
    <section className="mx-auto w-full max-w-[1000px] px-4 py-8 text-neutral-900">
      ...
      <div className="mt-6 space-y-6 text-sm leading-6 text-neutral-800">
        <section>
          ...
          <p className="mt-2">By accessing or using PoolBuy (the "Service"), you agree to these Terms. If you do not agree, please do not use the Service.</p>
        </section>
        ...
        <section>
          ...
          <p className="mt-2">Refunds are governed by our <a className="underline" href="/information/refund-policy">Refund Policy</a>. In summary, refunds may apply if the MOQ is not reached, if an item is lost or damaged in transit, or if an order is canceled before supplier confirmation. Additional terms may apply; please review the Refund Policy.</p>
        </section>
        ...
        <section>
          ...
          <p className="mt-2">Questions about these Terms can be sent to <a className="underline" href={`mailto:${email}`}>{email}</a>.</p>
        </section>
      </div>
    </section>
  );
