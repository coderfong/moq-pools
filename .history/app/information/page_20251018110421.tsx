...
export default function InformationPage() {
  ...
  <div className="order-1 lg:order-2 lg:col-span-7 xl:col-span-6 px-6 md:px-10 py-4 md:py-6 self-center justify-self-center w-full max-w-[640px] transform translate-x-11 md:translate-x-9">
