          ...
          <form onSubmit={onSubmit} className="bg-white/85 dark:bg-gray-900/70 backdrop-blur-xl rounded-3xl border border-hairline p-6 md:p-8 space-y-6 shadow-2xl">
            ...
            <div>
              ...
              <input
                ...
                className="mt-2 w-full rounded-2xl border border-hairline bg-surface px-4 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-orange-500"
                value={countrySearch}
                onChange={(e) => setCountrySearch(e.target.value)}
              />
              {/* Build filtered, alphabetically sorted list */}
              {(() => {
