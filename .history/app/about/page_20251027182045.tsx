    ...
    <div className="pb-12">
      ...
      <Section id="team" title="The Founding Team">
        <div className="grid gap-3 sm:grid-cols-2 md:grid-cols-3">
          {[
            { name: 'Alex Chen', role: 'Co‑founder, Ops & Supply', bio: '10+ years in cross‑border logistics and factory sourcing.' },
            { name: 'Mina Patel', role: 'Co‑founder, Product', bio: 'Built marketplaces and fintech for SMEs across APAC.' },
            { name: 'David Lin', role: 'Co‑founder, Engineering', bio: 'Shipping reliable, scalable systems for commerce.' },
          ].map((p, i) => (
            <div key={i} className="rounded-xl border border-neutral-200 bg-white p-4">
      ...
      <Section id="connect" title="Connect With Us">
        <div className="flex flex-wrap items-center gap-2 text-sm">
          ...
          <a href="mailto:hello@moqpools.com" className="rounded-lg border border-neutral-200 px-3 py-1.5 hover:bg-neutral-50">Email</a>
