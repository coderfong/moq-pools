          ...
          <div className="space-y-6">
            ...
            <div>
              ...
              <textarea
                ...
                onBlur={() => markFieldTouched('productDescription')}
              ...
              {getFieldError('productDescription') && (
                <p className="mt-1 text-sm text-red-600">{getFieldError('productDescription')}</p>
              )}
              <p className="mt-1 text-xs text-gray-500">
                {formData.productDescription.length}/20 characters minimum
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
              <div className="sm:col-span-2">
                ...
                <input
                  ...
                  onBlur={() => markFieldTouched('targetPrice')}
                  placeholder="e.g., 15.00"
                  min="0"
                  className={`w-full px-4 py-3 border rounded-lg focus:ring-2 focus:ring-orange-500 focus:border-transparent ${
                    getFieldError('targetPrice') ? 'border-red-500' : 'border-gray-300'
                  }`}
                  required
                />
                {getFieldError('targetPrice') && (
                  <p className="mt-1 text-sm text-red-600">{getFieldError('targetPrice')}</p>
                )}
              </div>
              <div>
