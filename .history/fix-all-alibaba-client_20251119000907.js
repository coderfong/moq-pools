...
const DELAY_BETWEEN_REQUESTS = 5000; // Increased to 5 seconds to avoid triggering Alibaba's anti-bot
const DELAY_BETWEEN_BATCHES = 10000; // 10 second pause between batches
