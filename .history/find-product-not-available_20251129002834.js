...
async function findProductNotAvailable() {
  try {
    ...
    if (totalSimilarCount > 0) {
      console.log('\n💡 To remove all these unavailable product listings, you can run:');
...
async function deleteProductNotAvailable() {
  try {
    console.log('🗑️ Deleting all unavailable product listings...\n');
    ...
    console.log(`✅ Successfully deleted ${deleteResult.count} unavailable product listings!`);
