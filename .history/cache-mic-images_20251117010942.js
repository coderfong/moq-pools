...
import { cacheExternalImage } from './src/lib/imageCache.js';
        ...
        try {
          ...
          if (result?.localPath) {
            ...
            if (cached % 100 === 0) {
              ...
              const rate = (cached / (Date.now() - startTime) * 1000).toFixed(1);
              const remaining = Math.ceil((listings.length - cached) / rate);
