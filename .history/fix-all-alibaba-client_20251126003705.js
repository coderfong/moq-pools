...
const DELAY_BETWEEN_BATCHES = 300; // Faster between batches
const PROGRESS_FILE = path.join(__dirname, 'alibaba-fix-progress.json');
const MAX_CONSECUTIVE_FALLBACKS = 25; // More tolerance for fallbacks
const BLOCK_COOLDOWN_MS = 3 * 60 * 1000; // 3 minutes cooldown when blocked
const MAX_CONCURRENT_REQUESTS = 10; // 10 parallel when running solo
const RATE_LIMIT_BACKOFF = 3000; // 3 seconds backoff
const INTER_CHUNK_DELAY = 30; // Minimal 30ms between chunks
