...
```
http://localhost:3007/api/alibaba/callback
```
...
- [ ] Set Callback URL: `http://localhost:3007/api/alibaba/callback`
...
- [ ] Test authorization: Visit `http://localhost:3007/api/alibaba/authorize`
