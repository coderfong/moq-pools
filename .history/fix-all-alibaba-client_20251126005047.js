...
const BLOCK_COOLDOWN_MS = 90 * 1000; // 90 seconds cooldown
const MAX_CONCURRENT_REQUESTS = 2; // Only 2 concurrent - very gentle
const RATE_LIMIT_BACKOFF = 8000; // 8 seconds backoff
const INTER_CHUNK_DELAY = 1000; // 1 second between chunks
